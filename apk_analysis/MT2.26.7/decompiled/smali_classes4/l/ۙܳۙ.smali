...
# instance fields
.field public final synthetic a:Ll/ۤ᩵ۙ;


# direct methods
.method public synthetic constructor <init>(Ll/ۤ᩵ۙ;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll/ۙܳۙ;->a:Ll/ۤ᩵ۙ;

    return-void
.end method

.method public static synthetic a(Ll/ۤ᩵ۙ;)Ljava/nio/file/attribute/BasicFileAttributes;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۗܳۙ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۗܳۙ;

    iget-object p0, p0, Ll/ۗܳۙ;->a:Ljava/nio/file/attribute/BasicFileAttributes;

    return-object p0

    :cond_1
    instance-of v0, p0, Ll/᩶ܳۙ;

    if-eqz v0, :cond_2

    check-cast p0, Ll/᩶ܳۙ;

    .line 0
    iget-object p0, p0, Ll/᩶ܳۙ;->a:Ljava/nio/file/attribute/DosFileAttributes;

    return-object p0

    :cond_2
    instance-of v0, p0, Ll/۬᩵ۙ;

    if-eqz v0, :cond_4

    check-cast p0, Ll/۬᩵ۙ;

    instance-of v0, p0, Ll/ۤܳۙ;

    if-eqz v0, :cond_3

    check-cast p0, Ll/ۤܳۙ;

    iget-object p0, p0, Ll/ۤܳۙ;->a:Ljava/nio/file/attribute/PosixFileAttributes;

    return-object p0

    :cond_3
    new-instance v0, Ll/۟ܳۙ;

    invoke-direct {v0, p0}, Ll/۟ܳۙ;-><init>(Ll/۬᩵ۙ;)V

    return-object v0

    :cond_4
    new-instance v0, Ll/ۙܳۙ;

    invoke-direct {v0, p0}, Ll/ۙܳۙ;-><init>(Ll/ۤ᩵ۙ;)V
...
.method public final synthetic creationTime()Ljava/nio/file/attribute/FileTime;
    ...
    iget-object v0, p0, Ll/ۙܳۙ;->a:Ll/ۤ᩵ۙ;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۙܳۙ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۙܳۙ;

    iget-object p1, p1, Ll/ۙܳۙ;->a:Ll/ۤ᩵ۙ;
