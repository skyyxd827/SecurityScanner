...
# static fields
.field public static final synthetic ۨۡ:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ll/ۜۧ᩺;->ۛۡ:Ll/ۙۧ᩺;

    .line 76
    new-instance v0, Ll/᩺ۙ᩺;

    invoke-direct {v0}, Ll/᩺ۙ᩺;-><init>()V

    iput-object v0, p0, Ll/ۜۧ᩺;->᩺ۡ:Ll/᩺ۙ᩺;

    const/4 v0, 0x1

    .line 77
    iput-boolean v0, p0, Ll/ۜۧ᩺;->ۖۡ:Z
...
.method public final ۜ(Lbin/mt/plus/Main;Ll/۠ܰۖ;Ll/۠ܰۖ;Ll/ܳۚۧ;)V
    ...
    .line 265
    :cond_0
    iget-object p1, p0, Ll/ۜۧ᩺;->᩺ۡ:Ll/᩺ۙ᩺;

    invoke-virtual {p1}, Ll/᩺ۙ᩺;->ۜ()Ljava/util/List;
...
.method public final ۡ(Ll/ܳۚۧ;)V
    ...
    .line 274
    iget-object p1, p0, Ll/ۜۧ᩺;->֡ۡ:Ll/ۜۤۛ;
    ...
    invoke-virtual {p1}, Ll/᩺ۙ᩺;->֡()Ll/ۛۗ᩺;
...
.method public final ۨ()V
    ...
    .line 101
    invoke-virtual {p0, v0}, Ll/ܽۚۧ;->֫(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Ll/֨᩻ۧ;->ۜ(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final ܺۜ()Ljava/lang/CharSequence;
    ...
    .line 89
    :cond_0
    iget-boolean v0, p0, Ll/ۜۧ᩺;->ۖۡ:Z
...
.method public final ᩸()Ll/ܳۚۧ;
    ...
    .line 111
    invoke-virtual {p0}, Ll/ܽۚۧ;->ۡۜ()Ll/ᩴۢۖ;

    move-result-object v0

    move-object v8, v0

    check-cast v8, Ll/ۛۗ᩺;
    ...
    invoke-virtual {v1, v3}, Ll/ۜۤۛ;->ۨ(Ljava/lang/String;)Ll/ۜۤۛ;

    move-result-object v1

    iput-object v1, p0, Ll/ۜۧ᩺;->֡ۡ:Ll/ۜۤۛ;

    .line 117
    invoke-virtual {v1}, Ll/ۜۤۛ;->֡ۜ()V

    .line 118
    iget-object v1, p0, Ll/ۜۧ᩺;->֡ۡ:Ll/ۜۤۛ;

    invoke-virtual {v1}, Ll/ۜۤۛ;->ᩳۜ()Ljava/lang/String;

    move-result-object v6

    new-instance v7, Ll/ܶۨ᩺;

    invoke-direct {v7, p0}, Ll/ܶۨ᩺;-><init>(Ll/ۜۧ᩺;)V

    iget-object v1, p0, Ll/ۜۧ᩺;->ۛۡ:Ll/ۙۧ᩺;

    move-object v3, v8

    move-object v4, v10

    invoke-virtual/range {v1 .. v7}, Ll/ۙۧ᩺;->ۜ(Ll/ۛۗ᩺;Ll/ۛۗ᩺;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ll/۬ۗ᩺;)V
    ...
    .line 163
    invoke-virtual {p0, v1}, Ll/֨᩻ۧ;->ۡ(Ljava/lang/CharSequence;)V

    const/4 v1, 0x0

    .line 164
    invoke-virtual {p0, v1}, Ll/֨᩻ۧ;->֡(Z)V
    ...
    invoke-virtual {p0, v1, v2}, Ll/֨᩻ۧ;->ۜ(Ljava/lang/String;Ljava/lang/String;)V

    .line 166
    new-instance v1, Ll/᩶۫᩺;

    iget-object v2, p0, Ll/ۜۧ᩺;->ۛۡ:Ll/ۙۧ᩺;

    invoke-virtual {v2}, Ll/ۙۧ᩺;->ۜ()Ljava/util/ArrayList;

    move-result-object v2

    invoke-direct {v1, v2}, Ll/᩶۫᩺;-><init>(Ljava/util/ArrayList;)V
    ...
    .line 199
    invoke-virtual {v1, v2, v3}, Ll/᩶۫᩺;->ۜ(Ljava/lang/String;Z)Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v4}, Ll/ۤ۫֡;-><init>(I)V
    ...
    new-instance v3, Ll/۫ۜ᩺;

    invoke-direct {v3, v4}, Ll/۫ۜ᩺;-><init>(I)V
    ...
    .line 170
    new-instance v2, Ll/ۘۨ᩺;

    invoke-direct {v2, p0}, Ll/ۘۨ᩺;-><init>(Ll/ۜۧ᩺;)V

    iget-object v3, p0, Ll/ۜۧ᩺;->᩺ۡ:Ll/᩺ۙ᩺;

    invoke-virtual {v3, v2}, Ll/᩺ۙ᩺;->ۜ(Ll/ۚۤۖ;)V
    ...
    .line 203
    new-instance v11, Ll/۬ۨ᩺;

    invoke-direct {v11, p0, v0}, Ll/۬ۨ᩺;-><init>(Ll/ۜۧ᩺;Z)V

    iget-object v6, p0, Ll/ۜۧ᩺;->᩺ۡ:Ll/᩺ۙ᩺;

    invoke-virtual/range {v6 .. v11}, Ll/᩺ۙ᩺;->ۜ(Ll/ᩴۢۖ;Ll/ۛۗ᩺;[Ljava/lang/String;Ljava/lang/String;Ll/ۛۙ᩺;)V
