...
.method public synthetic constructor <init>(Ljava/nio/file/attribute/BasicFileAttributes;)V
    ...
    iput-object p1, p0, Ll/ۗܳۙ;->a:Ljava/nio/file/attribute/BasicFileAttributes;

    return-void
.end method

.method public static synthetic a(Ljava/nio/file/attribute/BasicFileAttributes;)Ll/ۤ᩵ۙ;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۙܳۙ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۙܳۙ;

    iget-object p0, p0, Ll/ۙܳۙ;->a:Ll/ۤ᩵ۙ;
    ...
    .line 0
    new-instance v0, Ll/᩶ܳۙ;

    invoke-direct {v0, p0}, Ll/᩶ܳۙ;-><init>(Ljava/nio/file/attribute/DosFileAttributes;)V
    ...
    instance-of v0, p0, Ll/۟ܳۙ;

    if-eqz v0, :cond_3

    check-cast p0, Ll/۟ܳۙ;

    iget-object p0, p0, Ll/۟ܳۙ;->a:Ll/۬᩵ۙ;

    return-object p0

    :cond_3
    new-instance v0, Ll/ۤܳۙ;

    invoke-direct {v0, p0}, Ll/ۤܳۙ;-><init>(Ljava/nio/file/attribute/PosixFileAttributes;)V

    return-object v0

    :cond_4
    new-instance v0, Ll/ۗܳۙ;

    invoke-direct {v0, p0}, Ll/ۗܳۙ;-><init>(Ljava/nio/file/attribute/BasicFileAttributes;)V
...
# virtual methods
.method public final synthetic creationTime()Ll/ۘ᩵ۙ;
    .locals 1

    iget-object v0, p0, Ll/ۗܳۙ;->a:Ljava/nio/file/attribute/BasicFileAttributes;

    invoke-interface {v0}, Ljava/nio/file/attribute/BasicFileAttributes;->creationTime()Ljava/nio/file/attribute/FileTime;

    move-result-object v0

    invoke-static {v0}, Ll/ۨ᩸ۙ;->p(Ljava/nio/file/attribute/FileTime;)Ll/ۘ᩵ۙ;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۗܳۙ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۗܳۙ;

    iget-object p1, p1, Ll/ۗܳۙ;->a:Ljava/nio/file/attribute/BasicFileAttributes;
...
.method public final synthetic lastAccessTime()Ll/ۘ᩵ۙ;
    .locals 1
...
.method public final synthetic lastModifiedTime()Ll/ۘ᩵ۙ;
    .locals 1
