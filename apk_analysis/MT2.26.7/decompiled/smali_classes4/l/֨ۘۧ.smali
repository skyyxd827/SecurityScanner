...
.field public final ۖ:Landroid/graphics/Path;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ll/֨ۘۧ;->ۛ:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Ll/֨ۘۧ;->ۖ:Landroid/graphics/Path;

    const/high16 v0, 0x3f000000    # 0.5f

    .line 38
    iput v0, p0, Ll/֨ۘۧ;->ۗ:F

    const/16 v0, 0x30

    .line 45
    iput v0, p0, Ll/֨ۘۧ;->ܰ:I
    ...
    iput-object v0, p0, Ll/֨ۘۧ;->֡:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Ll/֨ۘۧ;->ۧ:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Ll/֨ۘۧ;->ۨ:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Ll/֨ۘۧ;->ۡ:Landroid/graphics/RectF;
    ...
    .line 268
    iput v0, p0, Ll/֨ۘۧ;->ܺ:F

    .line 269
    iput v0, p0, Ll/֨ۘۧ;->ۙ:F
    ...
    .line 327
    iput v0, p0, Ll/֨ۘۧ;->ۜ:F

    .line 328
    iput v1, p0, Ll/֨ۘۧ;->᩶:F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v4, p0, Ll/֨ۘۧ;->ܺ:F

    add-float/2addr v3, v4

    .line 194
    :cond_0
    iget-object v4, p0, Ll/֨ۘۧ;->֡:Landroid/graphics/RectF;
    ...
    iget v6, p0, Ll/֨ۘۧ;->ۙ:F

    goto :goto_0

    :cond_1
    iget v6, p0, Ll/֨ۘۧ;->ܳ:F
    ...
    iget v8, p0, Ll/֨ۘۧ;->ܺ:F

    sub-float/2addr v7, v8

    .line 208
    :cond_2
    iget-object v8, p0, Ll/֨ۘۧ;->ۧ:Landroid/graphics/RectF;
    ...
    iget v9, p0, Ll/֨ۘۧ;->ۙ:F

    goto :goto_1

    :cond_3
    iget v9, p0, Ll/֨ۘۧ;->ܳ:F
    ...
    iget v9, p0, Ll/֨ۘۧ;->ܺ:F

    sub-float/2addr v7, v9

    .line 222
    :cond_4
    iget-object v9, p0, Ll/֨ۘۧ;->ۨ:Landroid/graphics/RectF;
    ...
    iget v11, p0, Ll/֨ۘۧ;->ۙ:F

    sub-float/2addr v0, v11

    .line 226
    :cond_5
    iget v11, p0, Ll/֨ۘۧ;->᩺:F
    ...
    iget v2, p0, Ll/֨ۘۧ;->ܺ:F

    add-float/2addr v7, v2

    .line 238
    :cond_6
    iget-object v2, p0, Ll/֨ۘۧ;->ۡ:Landroid/graphics/RectF;
    ...
    .line 100
    iget-object v0, p0, Ll/֨ۘۧ;->ۖ:Landroid/graphics/Path;
    ...
    iget v12, p0, Ll/֨ۘۧ;->ۗ:F

    mul-float v7, v7, v12

    add-float/2addr v7, v5

    iget v5, p0, Ll/֨ۘۧ;->ܺ:F
    ...
    iget v8, p0, Ll/֨ۘۧ;->ۗ:F

    mul-float v7, v7, v8

    add-float/2addr v7, v5

    iget v5, p0, Ll/֨ۘۧ;->ۙ:F
    ...
    iget v4, p0, Ll/֨ۘۧ;->ۗ:F

    mul-float v3, v3, v4

    sub-float/2addr v2, v3

    iget v3, p0, Ll/֨ۘۧ;->ۙ:F
    ...
    .line 175
    iget v1, p0, Ll/֨ۘۧ;->᩸:I

    iget-object v2, p0, Ll/֨ۘۧ;->ۛ:Landroid/graphics/Paint;
...
.method public final getPadding(Landroid/graphics/Rect;)Z
    ...
    .line 333
    iget v0, p0, Ll/֨ۘۧ;->ۜ:F

    iget v1, p0, Ll/֨ۘۧ;->᩺:F

    add-float/2addr v0, v1

    .line 334
    iget v2, p0, Ll/֨ۘۧ;->᩶:F
...
.method public final setAlpha(I)V
    ...
    .line 253
    iget-object v0, p0, Ll/֨ۘۧ;->ۛ:Landroid/graphics/Paint;
