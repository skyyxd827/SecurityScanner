...
# direct methods
.method public static ۜ(Ll/ܽۚۧ;[Ljava/lang/String;Z)Ll/ۘ۟ۖ;
    .locals 2
    ...
    .line 189
    new-instance v1, Ll/ۨۘۖ;

    invoke-direct {v1, p0}, Ll/ۨۘۖ;-><init>(Ll/ܽۚۧ;)V

    invoke-virtual {v0, p1, p2, v1}, Ll/ۘ۟ۖ;->ۜ([Ljava/lang/String;ZLl/֨۟ۖ;)V
...
.method public static ۜ([Ljava/lang/String;Ljava/util/List;)V
    .locals 7
    ...
    new-instance v5, Ll/۠᩷ܳ;

    const/4 v6, 0x1

    invoke-direct {v5, v6, v3}, Ll/۠᩷ܳ;-><init>(ILjava/io/Serializable;)V
...
.method public final ֡(Ll/ܶܰۖ;)V
    ...
    new-instance v1, Ll/ۛ᩻ۖ;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Ll/ۛ᩻ۖ;-><init>(I)V
    ...
    .line 89
    :goto_0
    new-instance v2, Ll/᩺ۘۖ;

    invoke-virtual {p1}, Ll/ܶܰۖ;->᩺()Lbin/mt/plus/Main;

    move-result-object v3

    invoke-direct {v2, v3, p1}, Ll/᩺ۘۖ;-><init>(Lbin/mt/plus/Main;Ll/ܶܰۖ;)V

    .line 184
    invoke-virtual {v2, v1, v4}, Ll/ۡ᩹ۖ;->ۜ(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Ll/ܶܰۖ;->ۗ()I

    move-result p1

    invoke-virtual {v2, p1, v0}, Ll/ۡ᩹ۖ;->ۜ(IZ)V
