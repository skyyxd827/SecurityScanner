...
.method public static $default$thenComparing(Ljava/util/Comparator;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    .line 215
    new-instance v0, Ll/᩻֫ۙ;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, v1}, Ll/᩻֫ۙ;-><init>(Ljava/util/Comparator;Ljava/lang/Object;I)V
...
.method public static $default$thenComparing(Ljava/util/Comparator;Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-static {p0, p1}, Ll/ᩴۢۙ;->thenComparing(Ljava/util/Comparator;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public static $default$thenComparing(Ljava/util/Comparator;Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    .line 242
    invoke-static {p1, p2}, Ll/ۢۢۙ;->comparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public static $default$thenComparingDouble(Ljava/util/Comparator;Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    ...
    .line 531
    new-instance v0, Ll/۟ᩴۙ;

    const/4 v1, 0x1

    invoke-direct {v0, v1, p1}, Ll/۟ᩴۙ;-><init>(ILjava/lang/Object;)V

    .line 322
    invoke-static {p0, v0}, Ll/ᩴۢۙ;->thenComparing(Ljava/util/Comparator;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public static $default$thenComparingInt(Ljava/util/Comparator;Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    ...
    .line 284
    invoke-static {p1}, Ll/ۢۢۙ;->comparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
...
.method public static comparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-direct {v0, v1, p0}, Ll/۟ᩴۙ;-><init>(ILjava/lang/Object;)V
...
.method public static comparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    invoke-direct {v0, p1, p0, v1}, Ll/᩻֫ۙ;-><init>(Ljava/util/Comparator;Ljava/lang/Object;I)V
