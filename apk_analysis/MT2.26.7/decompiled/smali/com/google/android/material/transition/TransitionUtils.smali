...
.method public static maybeAddTransition(Ll/ۜۤۡ;Ll/۫ܿۡ;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 357
    invoke-virtual {p0, p1}, Ll/ۜۤۡ;->ۡ(Ll/۫ܿۡ;)V

    :cond_0
    return-void
.end method

.method public static maybeApplyThemeDuration(Ll/۫ܿۡ;Landroid/content/Context;I)Z
    .locals 5
    ...
    .line 79
    invoke-virtual {p0, p1, p2}, Ll/۫ܿۡ;->setDuration(J)Ll/۫ܿۡ;
...
.method public static maybeApplyThemeInterpolator(Ll/۫ܿۡ;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
...
.method public static maybeApplyThemePath(Ll/۫ܿۡ;Landroid/content/Context;I)Z
    .locals 0

    if-eqz p2, :cond_0

    .line 89
    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)Ll/ۖܿۡ;
    ...
    .line 91
    invoke-virtual {p0, p1}, Ll/۫ܿۡ;->setPathMotion(Ll/ۖܿۡ;)V
...
.method public static maybeRemoveTransition(Ll/ۜۤۡ;Ll/۫ܿۡ;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 363
    invoke-virtual {p0, p1}, Ll/ۜۤۡ;->֡(Ll/۫ܿۡ;)V

    :cond_0
    return-void
.end method

.method public static resolveThemePath(Landroid/content/Context;I)Ll/ۖܿۡ;
    .locals 2
    ...
    .line 114
    new-instance p1, Ll/᩺ܿۡ;

    invoke-static {p0}, Ll/᩸᩻;->ۡ(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-direct {p1, p0}, Ll/᩺ܿۡ;-><init>(Landroid/graphics/Path;)V
