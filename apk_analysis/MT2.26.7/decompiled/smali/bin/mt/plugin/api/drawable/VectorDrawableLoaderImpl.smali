...
.method public fromSvg(Ljava/io/InputStream;)Landroid/graphics/drawable/Drawable;
    ...
    .line 65
    :try_start_0
    invoke-static {p1}, Ll/۫ۨ᩵;->ۜ(Ljava/io/InputStream;)Ll/۫ۨ᩵;

    move-result-object p1

    .line 66
    invoke-virtual {p1}, Ll/۫ۨ᩵;->֡()Landroid/graphics/RectF;

    move-result-object v0

    .line 67
    invoke-virtual {p1}, Ll/۫ۨ᩵;->ۛ()F
    ...
    .line 75
    invoke-virtual {p1, v2}, Ll/۫ۨ᩵;->ۡ(F)V

    int-to-float v2, v1

    .line 76
    invoke-virtual {p1, v2}, Ll/۫ۨ᩵;->ۜ(F)V
    ...
    .line 80
    invoke-virtual {p1, v1}, Ll/۫ۨ᩵;->ۜ(Landroid/graphics/Canvas;)V
...
.method public fromVectorXml(Ljava/io/InputStream;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v0, v2}, Ll/ۢۗ᩸;->ۜ(Ll/᩻ܽ᩸;Ll/ۙ۬ۡ;Z)Ll/ۢۗ᩸;
    ...
    .line 48
    new-instance v1, Ll/ۘܽ᩸;

    new-instance v3, Ll/ۙ۬ۡ;

    invoke-direct {v3}, Ll/ۙ۬ۡ;-><init>()V

    invoke-direct {v1, v3}, Ll/ۘܽ᩸;-><init>(Ll/ۙ۬ۡ;)V

    .line 49
    sget-object v3, Ljava/util/Collections;->EMPTY_MAP:Ljava/util/Map;

    invoke-virtual {v1, v3}, Ll/ۘܽ᩸;->ۜ(Ljava/util/Map;)V

    const/4 v3, 0x1

    .line 50
    invoke-virtual {v1, v3}, Ll/ۘܽ᩸;->ۜ(Z)V

    sget-object v3, Ljava/nio/charset/StandardCharsets;->UTF_8:Ljava/nio/charset/Charset;

    .line 51
    invoke-static {p1, v3}, Ll/ۧۘܰ;->ۜ(Ljava/io/InputStream;Ljava/nio/charset/Charset;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, p1}, Ll/ۘܽ᩸;->ۜ(Ljava/lang/CharSequence;)V

    .line 52
    invoke-virtual {v1, v0}, Ll/ۘܽ᩸;->ۜ(Ll/ۤۛ֡;)V
