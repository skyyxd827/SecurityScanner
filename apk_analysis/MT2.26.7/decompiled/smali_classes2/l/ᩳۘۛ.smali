...
# static fields
.field public static final ֡:Ljava/util/ArrayList;
...
.field public static final ۡ:Ljava/lang/Iterable;

.field public static final ۨ:Ljava/util/List;

.field public static final ᩺:Ljava/util/List;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ll/ᩳۘۛ;->ۛ:Ljava/util/ArrayList;
    ...
    sput-object v1, Ll/ᩳۘۛ;->֡:Ljava/util/ArrayList;
    ...
    sput-object v2, Ll/ᩳۘۛ;->ۨ:Ljava/util/List;
    ...
    sput-object v2, Ll/ᩳۘۛ;->᩺:Ljava/util/List;

    .line 55
    invoke-static {v0, v1}, Ll/ۡۢ᩵;->ۜ(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/lang/Iterable;

    move-result-object v1

    sput-object v1, Ll/ᩳۘۛ;->ۡ:Ljava/lang/Iterable;
    ...
    sput-object v1, Ll/ᩳۘۛ;->ۖ:Ll/۫᩵ۜ;
    ...
    .line 84
    new-instance v12, Ll/ܽۘۛ;

    invoke-direct {v12, v10, v11, v9}, Ll/ܽۘۛ;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1, v3}, Ll/֨ᩴ᩸;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Ll/ᩳۘۛ;->֡:Ljava/util/ArrayList;
    ...
    .line 84
    new-instance v10, Ll/ܽۘۛ;

    invoke-direct {v10, v8, v9, v7}, Ll/ܽۘۛ;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static ֡()Ljava/lang/Iterable;
    .locals 1

    .line 115
    sget-object v0, Ll/ᩳۘۛ;->ۡ:Ljava/lang/Iterable;

    return-object v0
.end method

.method public static ֡(Ljava/lang/String;)Ll/ܽۘۛ;
    .locals 4

    .line 154
    const-class v0, Ll/ᩳۘۛ;

    monitor-enter v0

    .line 155
    :try_start_0
    sget-object v1, Ll/ᩳۘۛ;->ۛ:Ljava/util/ArrayList;
    ...
    check-cast v2, Ll/ܽۘۛ;

    .line 156
    iget-object v3, v2, Ll/ܽۘۛ;->ۨ:Ljava/lang/String;
...
.method public static ۖ()Ljava/util/List;
    ...
    .line 107
    sget-object v0, Ll/ᩳۘۛ;->ۨ:Ljava/util/List;
...
.method public static ۛ()Ljava/util/List;
    ...
    .line 111
    sget-object v0, Ll/ᩳۘۛ;->᩺:Ljava/util/List;

    return-object v0
.end method

.method public static ۜ(Ljava/util/List;)Lbin/mt/json/JSONArray;
    .locals 6
    ...
    .line 93
    iget-object v5, v2, Ll/ܽۘۛ;->᩺:Landroid/net/Uri;
    ...
    .line 94
    iget-object v5, v2, Ll/ܽۘۛ;->ۨ:Ljava/lang/String;
    ...
    .line 95
    iget-object v2, v2, Ll/ܽۘۛ;->ۖ:Ljava/lang/String;
...
.method public static ۜ(Ljava/io/File;)Ll/ۢۘۛ;
    .locals 8
    ...
    .line 323
    invoke-static {v1, v0}, Ll/᩻۬ܰ;->ۡ(Ljava/lang/CharSequence;Ljava/lang/String;)Z
    ...
    .line 305
    const-class v4, Ll/ᩳۘۛ;

    monitor-enter v4

    .line 306
    :try_start_0
    sget-object v5, Ll/ᩳۘۛ;->ۡ:Ljava/lang/Iterable;
    ...
    check-cast v6, Ll/ܽۘۛ;

    .line 307
    iget-object v7, v6, Ll/ܽۘۛ;->ۨ:Ljava/lang/String;
    ...
    .line 308
    invoke-virtual {v6, v0, v3}, Ll/ܽۘۛ;->ۜ(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v0

    .line 309
    iget-object v1, v6, Ll/ܽۘۛ;->᩺:Landroid/net/Uri;
    ...
    .line 311
    new-instance v1, Ll/۬ۘۛ;

    .line 30
    invoke-direct {v1, p0, v0, v6}, Ll/ۢۘۛ;-><init>(Ljava/io/File;Landroid/net/Uri;Ll/ܽۘۛ;)V
...
.method public static ۜ(Ljava/lang/String;)Ll/ܽۘۛ;
    .locals 4
    ...
    .line 143
    :try_start_0
    sget-object v1, Ll/ᩳۘۛ;->ۡ:Ljava/lang/Iterable;
...
.method public static ۜ(I)V
    ...
    check-cast p0, Ll/ܽۘۛ;

    invoke-virtual {p0}, Ll/ܽۘۛ;->ۡ()V
    ...
    .line 277
    new-instance p0, Ll/ۨ֡᩸;

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Ll/ۨ֡᩸;-><init>(I)V

    const-class v0, Ll/ᩳۘۛ;

    const-wide/16 v1, 0x1f4

    invoke-static {p0, v0, v1, v2}, Ll/ۘ֫᩸;->ۜ(Ljava/lang/Runnable;Ljava/lang/Object;J)V
...
.method public static ۜ(II)V
    ...
    invoke-direct {p0, p1}, Ll/ۨ֡᩸;-><init>(I)V

    const-class p1, Ll/ᩳۘۛ;

    const-wide/16 v0, 0x1f4

    invoke-static {p0, p1, v0, v1}, Ll/ۘ֫᩸;->ۜ(Ljava/lang/Runnable;Ljava/lang/Object;J)V
...
.method public static ۜ(Landroid/net/Uri;)V
    .locals 6

    .line 165
    invoke-static {p0}, Ll/᩻ܿ;->ۡ(Landroid/net/Uri;)Z
    ...
    .line 177
    invoke-static {v1}, Ll/ᩳۘۛ;->֡(Ljava/lang/String;)Ll/ܽۘۛ;
    ...
    .line 184
    invoke-static {p0}, Ll/ᩳۘۛ;->ۡ(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v3, p0}, Ll/ۙۡۜ;->ۜ(Landroid/app/Application;Landroid/net/Uri;)Ll/ۙۡۜ;

    move-result-object v3

    invoke-virtual {v3}, Ll/ۙۡۜ;->ۜ()Ljava/lang/String;
    ...
    .line 204
    invoke-static {p0}, Ll/ܳۘۛ;->ۡ(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v2}, Ll/֨ۘۡ;->ۜ(Ljava/lang/Object;)Landroid/os/storage/StorageVolume;
    ...
    .line 220
    :try_start_2
    sget-object v2, Ll/ᩳۘۛ;->ۛ:Ljava/util/ArrayList;

    new-instance v4, Ll/ܽۘۛ;

    invoke-direct {v4, p0, v1, v3}, Ll/ܽۘۛ;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 221
    sget-object p0, Ll/ᩳۘۛ;->֡:Ljava/util/ArrayList;

    new-instance v2, Ll/ᩴۘۛ;

    invoke-direct {v2, v1}, Ll/ᩴۘۛ;-><init>(Ljava/lang/String;)V

    invoke-static {p0, v2}, Ll/ܺۢۙ;->removeIf(Ljava/util/Collection;Ljava/util/function/Predicate;)Z
    ...
    .line 224
    sget-object p0, Ll/ᩳۘۛ;->ۖ:Ll/۫᩵ۜ;
...
.method public static ۜ(Lbin/mt/plus/Main;Ll/ۛۚۖ;)V
    .locals 1

    .line 103
    sget-object v0, Ll/ᩳۘۛ;->ۖ:Ll/۫᩵ۜ;
...
.method public static ۡ(Landroid/net/Uri;)Ljava/lang/String;
    .locals 2
...
.method public static ۡ(Ljava/lang/String;)Ll/ܽۘۛ;
    .locals 4
    ...
    .line 121
    iget-object v2, v1, Ll/ܽۘۛ;->᩺:Landroid/net/Uri;
    ...
    invoke-static {v2}, Ll/ᩳۘۛ;->ۡ(Landroid/net/Uri;)Ljava/lang/String;
...
.method public static ۡ()V
    ...
    sget-object v1, Ll/ᩳۘۛ;->ۨ:Ljava/util/List;
...
.method public static ۡ(I)V
    ...
    .line 257
    :try_start_0
    sget-object v1, Ll/ᩳۘۛ;->֡:Ljava/util/ArrayList;
...
.method public static declared-synchronized ᩺()V
    .locals 5
    ...
    invoke-static {v2}, Ll/ᩳۘۛ;->ۜ(Ljava/util/List;)Lbin/mt/json/JSONArray;
    ...
    .line 284
    sget-object v3, Ll/ᩳۘۛ;->֡:Ljava/util/ArrayList;

    invoke-static {v3}, Ll/ᩳۘۛ;->ۜ(Ljava/util/List;)Lbin/mt/json/JSONArray;
    ...
    .line 287
    invoke-interface {v1, v4, v2}, Ll/۟ᩴ᩸;->putString(Ljava/lang/String;Ljava/lang/String;)Ll/۟ᩴ᩸;
