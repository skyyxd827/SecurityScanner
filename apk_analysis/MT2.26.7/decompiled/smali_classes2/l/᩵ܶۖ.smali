...
.field public final ۠:Ll/᩺ܶۖ;

.field public final ۢ:Ljava/lang/String;

.field public ܽ:Ll/ܶ᩻ۖ;

.field public ᩳ:Ll/ᩴܶۖ;
...
.method public constructor <init>(ILnet/sf/sevenzipjbinding/IInArchive;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Ll/᩵ܶۖ;->ܽ:Ll/ܶ᩻ۖ;
    ...
    iput-object p1, p0, Ll/᩵ܶۖ;->ᩴ:Ll/ۨ᩻ۖ;
    ...
    iput-object p1, p0, Ll/᩵ܶۖ;->֫:Ll/ۧ᩻ۖ;

    .line 63
    new-instance p1, Ll/᩺ܶۖ;

    invoke-direct {p1, p3}, Ll/᩺ܶۖ;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Ll/᩵ܶۖ;->۠:Ll/᩺ܶۖ;

    .line 64
    invoke-virtual {p1}, Ll/᩺ܶۖ;->᩶()Ll/ۜۤۛ;
    ...
    iput-object v0, p0, Ll/᩵ܶۖ;->ۢ:Ljava/lang/String;

    .line 65
    invoke-virtual {p0, p3}, Ll/᩻ۙۖ;->֡(Ljava/lang/String;)V

    .line 67
    :try_start_0
    invoke-virtual {p1, p2}, Ll/᩺ܶۖ;->ۜ(Lnet/sf/sevenzipjbinding/IInArchive;)V

    .line 68
    invoke-virtual {p1}, Ll/᩺ܶۖ;->᩺()Z
    ...
    .line 69
    new-instance p2, Ll/ᩴܶۖ;

    invoke-direct {p2, p1}, Ll/ᩴܶۖ;-><init>(Ll/᩺ܶۖ;)V

    iput-object p2, p0, Ll/᩵ܶۖ;->ᩳ:Ll/ᩴܶۖ;
    :try_end_0
...
.method public constructor <init>(Ll/᩻ۛ֡;)V
    ...
    iput-object v0, p0, Ll/᩵ܶۖ;->ܽ:Ll/ܶ᩻ۖ;
    ...
    iput-object v0, p0, Ll/᩵ܶۖ;->ᩴ:Ll/ۨ᩻ۖ;
    ...
    iput-object v0, p0, Ll/᩵ܶۖ;->֫:Ll/ۧ᩻ۖ;

    .line 79
    invoke-static {p1}, Ll/᩺ܶۖ;->ۜ(Ll/᩻ۛ֡;)Ll/᩺ܶۖ;
    ...
    iput-object p1, p0, Ll/᩵ܶۖ;->ۢ:Ljava/lang/String;

    return-void
.end method

.method public static bridge synthetic ۜ(Ll/᩵ܶۖ;)Ll/᩺ܶۖ;
    .locals 0

    .line 0
    iget-object p0, p0, Ll/᩵ܶۖ;->۠:Ll/᩺ܶۖ;

    return-object p0
.end method

.method public static synthetic ۡ(Ll/᩵ܶۖ;)Ll/ۜۤۛ;
    .locals 0
...
.method public final ۖۜ()Ljava/lang/String;
    ...
    .line 207
    iget-object v0, p0, Ll/᩵ܶۖ;->۠:Ll/᩺ܶۖ;

    invoke-virtual {v0}, Ll/᩺ܶۖ;->ܰ()Ljava/lang/String;
...
.method public final ۜ()Ll/ܶ᩻ۖ;
    ...
    .line 238
    iget-object v0, p0, Ll/᩵ܶۖ;->ܽ:Ll/ܶ᩻ۖ;
...
.method public final ۜ(Ll/۠ܰۖ;Ljava/util/List;Ljava/lang/Runnable;)V
    ...
    .line 255
    new-instance v0, Ll/᩸ܶۖ;

    invoke-direct {v0, p0, p1, p2, p3}, Ll/᩸ܶۖ;-><init>(Ll/᩵ܶۖ;Ll/۠ܰۖ;Ljava/util/List;Ljava/lang/Runnable;)V
...
.method public final ۜ(Ll/۠ܰۖ;Ll/۠ܰۖ;)V
    ...
    .line 179
    iget-object p1, p0, Ll/᩵ܶۖ;->ۢ:Ljava/lang/String;

    invoke-virtual {p2, p1}, Ll/۠ܰۖ;->ۛ(Ljava/lang/String;)V

    .line 180
    iget-object p1, p0, Ll/᩵ܶۖ;->۠:Ll/᩺ܶۖ;
...
.method public final ۜ(Ll/ۤۛ֡;)V
    ...
    invoke-virtual {v0, p1}, Ll/᩺ܶۖ;->ۜ(Ll/ۤۛ֡;)V
...
.method public final declared-synchronized ۜ(Lnet/sf/sevenzipjbinding/IInArchive;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Ll/᩺ܶۖ;->ۡ(Lnet/sf/sevenzipjbinding/IInArchive;)V
    :try_end_0
...
.method public final ۜ(Z)V
    ...
    invoke-virtual {v0, p1}, Ll/᩺ܶۖ;->ۜ(Z)V

    .line 120
    invoke-virtual {v0}, Ll/᩺ܶۖ;->᩺()Z
    ...
    .line 121
    iget-object p1, p0, Ll/᩵ܶۖ;->ᩳ:Ll/ᩴܶۖ;

    if-eqz p1, :cond_0

    .line 122
    invoke-virtual {p1}, Ll/ᩴܶۖ;->ۡ()V

    .line 124
    :cond_0
    new-instance p1, Ll/ᩴܶۖ;

    invoke-direct {p1, v0}, Ll/ᩴܶۖ;-><init>(Ll/᩺ܶۖ;)V

    iput-object p1, p0, Ll/᩵ܶۖ;->ᩳ:Ll/ᩴܶۖ;
...
.method public final ۜ(Ljava/lang/String;)Z
    ...
    .line 186
    iget-object v1, p0, Ll/᩵ܶۖ;->۠:Ll/᩺ܶۖ;

    invoke-virtual {v1, p1}, Ll/᩺ܶۖ;->֡(Ljava/lang/String;)Ll/ۨۜۛ;
...
.method public final ۟()Ljava/util/List;
    ...
    iget-object v5, p0, Ll/᩵ܶۖ;->ᩴ:Ll/ۨ᩻ۖ;

    aput-object v5, v4, v3

    const/4 v3, 0x2

    iget-object v5, p0, Ll/᩵ܶۖ;->֫:Ll/ۧ᩻ۖ;
...
.method public final ۤ()Ljava/util/List;
    ...
    invoke-virtual {v0}, Ll/᩺ܶۖ;->ۢ()Ljava/util/List;
    ...
    .line 132
    invoke-virtual {p0, v2}, Ll/᩵ܶۖ;->ۜ(Z)V
    ...
    .line 199
    invoke-virtual {v0, v1, v3}, Ll/᩺ܶۖ;->ۜ(Ljava/lang/String;Z)Ljava/util/ArrayList;
...
.method public final ۨ()Ll/۫ۗۖ;
    ...
    .line 151
    iget-object v0, p0, Ll/᩵ܶۖ;->ᩳ:Ll/ᩴܶۖ;

    return-object v0

    .line 153
    :cond_0
    invoke-static {}, Ll/۫֨ۖ;->ۡ()Ll/۫֨ۖ;
...
.method public final ۫()Ljava/lang/String;
    ...
    iget-object v1, p0, Ll/᩵ܶۖ;->ۢ:Ljava/lang/String;
...
.method public final ᩺()Ll/ۢۙۖ;
    ...
    invoke-virtual {v1}, Ll/᩺ܶۖ;->ܰ()Ljava/lang/String;

    move-result-object v1

    sget-object v2, Ll/᩸ᩴۖ;->᩶:Ll/᩸ᩴۖ;

    iget-object v3, p0, Ll/᩵ܶۖ;->ۢ:Ljava/lang/String;
...
.method public final declared-synchronized ᩺ۜ()Lnet/sf/sevenzipjbinding/IInArchive;
    .locals 1
    ...
    invoke-virtual {v0}, Ll/᩺ܶۖ;->ᩳ()Lnet/sf/sevenzipjbinding/IInArchive;
