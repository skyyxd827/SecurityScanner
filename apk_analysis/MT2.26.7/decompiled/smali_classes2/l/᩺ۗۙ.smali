.class public final synthetic Ll/᩺ۗۙ;
.super Ll/᩸᩵ۙ;
.source "J66Z"
...
.method public synthetic constructor <init>(Ljava/nio/file/FileSystem;)V
    ...
    iput-object p1, p0, Ll/᩺ۗۙ;->a:Ljava/nio/file/FileSystem;

    return-void
.end method

.method public static synthetic b(Ljava/nio/file/FileSystem;)Ll/᩸᩵ۙ;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۧۗۙ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۧۗۙ;

    iget-object p0, p0, Ll/ۧۗۙ;->a:Ll/᩸᩵ۙ;
    ...
    invoke-direct {v0, p0}, Ll/᩺ۗۙ;-><init>(Ljava/nio/file/FileSystem;)V
...
.method public final synthetic close()V
    ...
    iget-object v0, p0, Ll/᩺ۗۙ;->a:Ljava/nio/file/FileSystem;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/᩺ۗۙ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/᩺ۗۙ;

    iget-object p1, p1, Ll/᩺ۗۙ;->a:Ljava/nio/file/FileSystem;
...
.method public final synthetic getPath(Ljava/lang/String;[Ljava/lang/String;)Ll/ᩴ᩵ۙ;
    .locals 1
...
.method public final synthetic getPathMatcher(Ljava/lang/String;)Ll/֫᩵ۙ;
    .locals 1
    ...
    .line 0
    :cond_0
    instance-of v0, p1, Ll/ۘܳۙ;

    if-eqz v0, :cond_1

    check-cast p1, Ll/ۘܳۙ;

    iget-object p1, p1, Ll/ۘܳۙ;->a:Ll/֫᩵ۙ;

    return-object p1

    :cond_1
    new-instance v0, Ll/᩻᩵ۙ;

    invoke-direct {v0, p1}, Ll/᩻᩵ۙ;-><init>(Ljava/nio/file/PathMatcher;)V
...
.method public final synthetic getUserPrincipalLookupService()Ll/ۡܳۙ;
    .locals 2
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Ll/᩸ܳۙ;

    if-eqz v1, :cond_1

    check-cast v0, Ll/᩸ܳۙ;

    iget-object v0, v0, Ll/᩸ܳۙ;->a:Ll/ۡܳۙ;

    return-object v0

    :cond_1
    new-instance v1, Ll/ۨܳۙ;

    invoke-direct {v1, v0}, Ll/ۨܳۙ;-><init>(Ljava/nio/file/attribute/UserPrincipalLookupService;)V
...
.method public final synthetic newWatchService()Ll/ۚ᩵ۙ;
    .locals 1
    ...
    invoke-static {v0}, Ll/ᩳۗۙ;->b(Ljava/nio/file/WatchService;)Ll/ۚ᩵ۙ;
...
.method public final synthetic provider()Ll/ۘۗۙ;
    .locals 2
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Ll/ۡۙۙ;

    if-eqz v1, :cond_1

    check-cast v0, Ll/ۡۙۙ;

    iget-object v0, v0, Ll/ۡۙۙ;->a:Ll/ۘۗۙ;

    return-object v0

    :cond_1
    new-instance v1, Ll/ۜۙۙ;

    invoke-direct {v1, v0}, Ll/ۜۙۙ;-><init>(Ljava/nio/file/spi/FileSystemProvider;)V
