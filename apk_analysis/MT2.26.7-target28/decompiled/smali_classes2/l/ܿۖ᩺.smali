...
.method public static synthetic ۜ(Landroid/widget/TextView;Ljava/util/ArrayList;)V
    .locals 0

    .line 70
    invoke-static {p1}, Ll/ܿۖ᩺;->ۜ(Ljava/util/ArrayList;)Ljava/lang/String;
...
.method public static synthetic ۜ(Ll/֡ܺۛ;Ll/۬ۖ᩺;Landroid/widget/CheckBox;Ll/ܶܰۖ;Lbin/mt/plus/Main;Ll/ۚ᩷ۧ;Ljava/util/ArrayList;)V
    .locals 7
    ...
    .line 101
    invoke-virtual {p3}, Ll/ܶܰۖ;->ۨ()Ljava/lang/String;
    ...
    .line 103
    invoke-virtual {p4}, Ll/۬۠ۨ;->buildDialog()Ll/۫᩷ۧ;

    move-result-object p1

    invoke-virtual {p1, p0}, Ll/۫᩷ۧ;->ۡ(Ljava/lang/CharSequence;)V
    ...
    invoke-direct/range {v1 .. v6}, Ll/ۚۖ᩺;-><init>(Ll/ۚ᩷ۧ;Ll/ܶܰۖ;Ljava/util/ArrayList;Ll/ۜۤۛ;Landroid/widget/CheckBox;)V
    ...
    invoke-static {p3, p6, v5, p0}, Ll/ܿۖ᩺;->ۜ(Ll/ܶܰۖ;Ljava/util/ArrayList;Ll/ۜۤۛ;Z)V

    return-void
.end method

.method public static synthetic ۜ(Ll/ۚ᩷ۧ;Ll/ܶܰۖ;Ljava/util/ArrayList;Ll/ۜۤۛ;Landroid/widget/CheckBox;)V
    .locals 0
    ...
    invoke-static {p1, p2, p3, p0}, Ll/ܿۖ᩺;->ۜ(Ll/ܶܰۖ;Ljava/util/ArrayList;Ll/ۜۤۛ;Z)V

    return-void
.end method

.method public static ۜ(Ll/ܶܰۖ;Ljava/util/ArrayList;Ll/ۜۤۛ;Z)V
    .locals 2
    ...
    const-class v1, Ll/᩻ۖ᩺;

    invoke-direct {v0, v1}, Ll/۫ۚۧ;-><init>(Ljava/lang/Class;)V

    .line 120
    invoke-virtual {v0, p0}, Ll/۫ۚۧ;->֡(Ll/ܶܰۖ;)V
    ...
    .line 122
    invoke-virtual {v0, p1}, Ll/۫ۚۧ;->ۜ(Ljava/util/List;)V

    const-string p0, "removeSources"

    .line 123
    invoke-virtual {v0, p0, p3}, Ll/۫ۚۧ;->ۜ(Ljava/lang/String;Z)V
...
.method public final ֡(Ll/ܶܰۖ;)V
    ...
    new-instance v10, Ll/᩷ۖ᩺;

    invoke-direct {v10, v5, v7, v3}, Ll/᩷ۖ᩺;-><init>(Lbin/mt/plus/Main;Ljava/util/ArrayList;Landroid/widget/TextView;)V

    invoke-virtual {v9, v10}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 72
    new-instance v9, Ll/۬ۖ᩺;

    invoke-direct {v9}, Ll/۬ۖ᩺;-><init>()V

    .line 73
    invoke-virtual {v9}, Ll/۬ۖ᩺;->ۡ()V

    .line 75
    invoke-virtual {v5}, Ll/֫ۖ;->getResources()Landroid/content/res/Resources;
    ...
    .line 76
    iget-boolean v10, v9, Ll/۬ۖ᩺;->۬:Z

    invoke-virtual {v8, v10}, Landroid/widget/CompoundButton;->setChecked(Z)V

    .line 77
    invoke-static {v7}, Ll/ܿۖ᩺;->ۜ(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v1}, Ll/֡ܺۛ;->ۡ(Ljava/lang/CharSequence;)V
    ...
    invoke-direct/range {v0 .. v7}, Ll/۫ۖ᩺;-><init>(Ll/֡ܺۛ;Ll/۬ۖ᩺;Landroid/widget/CheckBox;Ll/ܶܰۖ;Lbin/mt/plus/Main;Ll/ۚ᩷ۧ;Ljava/util/ArrayList;)V
