...
.method public static bridge_synchronizedSet(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
    ...
    .line 1167
    new-instance v0, Ll/᩺ᩳۙ;

    .line 1181
    invoke-direct {v0, p0, p1}, Ll/ܿܽۙ;-><init>(Ljava/util/Collection;Ljava/lang/Object;)V
...
.method public static synchronizedList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 1458
    invoke-direct {v0, p0}, Ll/֨ܽۙ;-><init>(Ljava/util/List;)V

    return-object v0

    .line 1327
    :cond_0
    new-instance v0, Ll/֨ܽۙ;
...
.method public static synchronizedMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1513
    new-instance v0, Ll/۬ܽۙ;

    invoke-direct {v0, p0}, Ll/۬ܽۙ;-><init>(Ljava/util/Map;)V
...
.method public static synchronizedSet(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 1177
    invoke-direct {v0, p0}, Ll/ܿܽۙ;-><init>(Ljava/util/Collection;)V
...
.method public static unmodifiableCollection(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    invoke-direct {v0, p0}, Ll/ܳᩳۙ;-><init>(Ljava/util/Collection;)V
...
.method public static unmodifiableList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 335
    new-instance v0, Ll/᩶۟ۙ;

    .line 472
    invoke-direct {v0, p0}, Ll/ܺᩳۙ;-><init>(Ljava/util/List;)V

    return-object v0

    .line 336
    :cond_0
    new-instance v0, Ll/ܺᩳۙ;
...
.method public static unmodifiableMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 505
    new-instance v0, Ll/᩹ᩳۙ;

    invoke-direct {v0, p0}, Ll/᩹ᩳۙ;-><init>(Ljava/util/Map;)V
...
.method public static unmodifiableSortedMap(Ljava/util/SortedMap;)Ljava/util/SortedMap;
    ...
    .line 900
    new-instance v0, Ll/ܽ۟ۙ;

    invoke-direct {v0, p0}, Ll/ܽ۟ۙ;-><init>(Ljava/util/SortedMap;)V
