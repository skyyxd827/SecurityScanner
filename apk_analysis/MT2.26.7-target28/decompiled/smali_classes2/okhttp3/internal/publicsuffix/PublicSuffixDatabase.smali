...
.method public static binarySearchBytes([B[[BI)Ljava/lang/String;
    ...
    sget-object p2, Ll/ۛ᩹ܰ;->ܺ:Ljava/nio/charset/Charset;
...
.method private findMatchingRule([Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v6, Ll/ۛ᩹ܰ;->ܺ:Ljava/nio/charset/Charset;
...
.method private readTheList()V
    ...
    .line 316
    new-instance v1, Ll/᩶ۚܰ;

    invoke-static {v0}, Ll/۠ۚܰ;->ۜ(Ljava/io/InputStream;)Ll/۬ۚܰ;

    move-result-object v0

    invoke-direct {v1, v0}, Ll/᩶ۚܰ;-><init>(Ll/۬ۚܰ;)V
    ...
    .line 318
    :try_start_0
    invoke-interface {v0}, Ll/ܳۚܰ;->readInt()I
    ...
    .line 320
    invoke-interface {v0, v1}, Ll/ܳۚܰ;->readFully([B)V
    ...
    .line 324
    invoke-interface {v0, v2}, Ll/ܳۚܰ;->readFully([B)V
    :try_end_0
...
.method private readTheListUninterruptibly()V
    ...
    invoke-virtual {v2, v4, v3, v1}, Ll/۟۫ܰ;->ۜ(ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
