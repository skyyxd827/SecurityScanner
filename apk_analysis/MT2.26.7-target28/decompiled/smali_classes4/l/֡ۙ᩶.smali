...
.method public static varargs ۜ(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    ...
    invoke-static {v0}, Ll/֡ۙ᩶;->ۜ(C)Ljava/lang/String;
...
.method public static ۜ([I)Ljava/lang/String;
    ...
    .line 326
    invoke-static {p0}, Ll/ܽۢۙ;->stream([I)Ll/ܶᩳۙ;

    move-result-object p0

    new-instance v0, Ll/ۜۙ᩶;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    invoke-interface {p0, v0}, Ll/ܶᩳۙ;->mapToObj(Ljava/util/function/IntFunction;)Ll/ۜ۠ۙ;
...
.method public static ۜ(IILjava/io/DataInputStream;)Ljava/util/ArrayList;
    .locals 13
    ...
    .line 224
    invoke-static {p1, v7}, Ll/֡ۙ᩶;->ۜ(ILjava/lang/String;)Ljava/util/ArrayList;
    ...
    new-instance p1, Ll/ۘۗ᩶;

    const/4 p2, 0x0

    invoke-direct {p1, v2, p2}, Ll/ۘۗ᩶;-><init>(Ljava/util/ArrayList;I)V

    .line 227
    invoke-interface {p0, p1}, Ll/ۜ۠ۙ;->forEach(Ljava/util/function/Consumer;)V
    ...
    invoke-direct {p1, p2}, Ll/ܰ֨ۛ;-><init>(I)V

    invoke-interface {p0, p1}, Ll/ۜ۠ۙ;->map(Ljava/util/function/Function;)Ll/ۜ۠ۙ;

    move-result-object p0

    new-instance p1, Ll/۬ۗ᩶;

    invoke-direct {p1, v2}, Ll/۬ۗ᩶;-><init>(Ljava/util/ArrayList;)V
    ...
    new-instance p2, Ll/ۘۗ᩶;

    const/4 v0, 0x0

    invoke-direct {p2, v2, v0}, Ll/ۘۗ᩶;-><init>(Ljava/util/ArrayList;I)V
    ...
    new-instance p2, Ll/ܰ֨ۛ;

    const/4 v0, 0x7

    invoke-direct {p2, v0}, Ll/ܰ֨ۛ;-><init>(I)V

    invoke-interface {p1, p2}, Ll/ۜ۠ۙ;->map(Ljava/util/function/Function;)Ll/ۜ۠ۙ;

    move-result-object p1

    new-instance p2, Ll/۬ۗ᩶;

    invoke-direct {p2, v2}, Ll/۬ۗ᩶;-><init>(Ljava/util/ArrayList;)V
...
.method public static ۜ(ILjava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Ll/֡ۙ᩶;->ۜ(C)Ljava/lang/String;
