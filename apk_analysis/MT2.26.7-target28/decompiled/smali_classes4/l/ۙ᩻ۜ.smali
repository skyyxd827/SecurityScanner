...
# direct methods
.method public static ۜ(Ll/ۧܰۜ;Z)Landroid/media/AudioAttributes;
    .locals 0
    ...
    .line 116
    :cond_0
    invoke-virtual {p0}, Ll/ۧܰۜ;->ۜ()Ll/ۨܰۜ;

    move-result-object p0

    iget-object p0, p0, Ll/ۨܰۜ;->ۜ:Landroid/media/AudioAttributes;
...
# virtual methods
.method public final ۜ(Ll/᩵ۚۜ;Ll/ۧܰۜ;ILandroid/content/Context;)Landroid/media/AudioTrack;
    .locals 6

    .line 45
    iget-boolean v0, p1, Ll/᩵ۚۜ;->᩺:Z

    iget v1, p1, Ll/᩵ۚۜ;->֡:I

    iget v2, p1, Ll/᩵ۚۜ;->ۡ:I

    iget v3, p1, Ll/᩵ۚۜ;->ۖ:I
    ...
    .line 59
    invoke-static {v3, v2, v1}, Ll/ᩴᩴۜ;->ۡ(III)Landroid/media/AudioFormat;

    move-result-object v1

    .line 62
    invoke-static {p2, v0}, Ll/ۙ᩻ۜ;->ۜ(Ll/ۧܰۜ;Z)Landroid/media/AudioAttributes;
