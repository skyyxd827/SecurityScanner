.class public final synthetic Ll/ۖۙۙ;
...
# instance fields
.field public final synthetic a:Ll/ᩴ᩵ۙ;


# direct methods
.method public synthetic constructor <init>(Ll/ᩴ᩵ۙ;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll/ۖۙۙ;->a:Ll/ᩴ᩵ۙ;

    return-void
.end method

.method public static synthetic k(Ll/ᩴ᩵ۙ;)Ljava/nio/file/Path;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۛۙۙ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۛۙۙ;

    iget-object p0, p0, Ll/ۛۙۙ;->a:Ljava/nio/file/Path;
    ...
    invoke-direct {v0, p0}, Ll/ۖۙۙ;-><init>(Ll/ᩴ᩵ۙ;)V
...
.method public final synthetic compareTo(Ljava/lang/Object;)I
    ...
    iget-object v0, p0, Ll/ۖۙۙ;->a:Ll/ᩴ᩵ۙ;
...
.method public final synthetic compareTo(Ljava/nio/file/Path;)I
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->compareTo(Ll/ᩴ᩵ۙ;)I
...
.method public final synthetic endsWith(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->endsWith(Ljava/lang/String;)Z
...
.method public final synthetic endsWith(Ljava/nio/file/Path;)Z
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->endsWith(Ll/ᩴ᩵ۙ;)Z
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۖۙۙ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۖۙۙ;

    iget-object p1, p1, Ll/ۖۙۙ;->a:Ll/ᩴ᩵ۙ;
...
.method public final synthetic getFileName()Ljava/nio/file/Path;
    ...
    invoke-static {v0}, Ll/ۖۙۙ;->k(Ll/ᩴ᩵ۙ;)Ljava/nio/file/Path;
...
.method public final synthetic getFileSystem()Ljava/nio/file/FileSystem;
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->getFileSystem()Ll/᩸᩵ۙ;

    move-result-object v0

    invoke-static {v0}, Ll/ۧۗۙ;->b(Ll/᩸᩵ۙ;)Ljava/nio/file/FileSystem;
...
.method public final synthetic getName(I)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->getName(I)Ll/ᩴ᩵ۙ;
...
.method public final synthetic getNameCount()I
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->getNameCount()I
...
.method public final synthetic getRoot()Ljava/nio/file/Path;
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->getRoot()Ll/ᩴ᩵ۙ;
...
.method public final synthetic isAbsolute()Z
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->isAbsolute()Z
...
.method public final iterator()Ljava/util/Iterator;
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->iterator()Ljava/util/Iterator;
...
.method public final synthetic normalize()Ljava/nio/file/Path;
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->normalize()Ll/ᩴ᩵ۙ;
...
.method public final synthetic register(Ljava/nio/file/WatchService;[Ljava/nio/file/WatchEvent$Kind;)Ljava/nio/file/WatchKey;
    ...
    invoke-interface {v0, p1, p2}, Ll/ᩴ᩵ۙ;->register(Ll/ۚ᩵ۙ;[Ll/᩹᩵ۙ;)Ll/۫᩵ۙ;
...
.method public final synthetic register(Ljava/nio/file/WatchService;[Ljava/nio/file/WatchEvent$Kind;[Ljava/nio/file/WatchEvent$Modifier;)Ljava/nio/file/WatchKey;
    ...
    invoke-interface {v0, p1, p2, p3}, Ll/ᩴ᩵ۙ;->register(Ll/ۚ᩵ۙ;[Ll/᩹᩵ۙ;[Ll/᩷᩵ۙ;)Ll/۫᩵ۙ;
...
.method public final synthetic relativize(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->relativize(Ll/ᩴ᩵ۙ;)Ll/ᩴ᩵ۙ;
...
.method public final synthetic resolve(Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->resolve(Ljava/lang/String;)Ll/ᩴ᩵ۙ;
...
.method public final synthetic resolve(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->resolve(Ll/ᩴ᩵ۙ;)Ll/ᩴ᩵ۙ;
...
.method public final synthetic resolveSibling(Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->resolveSibling(Ljava/lang/String;)Ll/ᩴ᩵ۙ;
...
.method public final synthetic resolveSibling(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->resolveSibling(Ll/ᩴ᩵ۙ;)Ll/ᩴ᩵ۙ;
...
.method public final synthetic startsWith(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->startsWith(Ljava/lang/String;)Z
...
.method public final synthetic startsWith(Ljava/nio/file/Path;)Z
    ...
    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->startsWith(Ll/ᩴ᩵ۙ;)Z
...
.method public final synthetic subpath(II)Ljava/nio/file/Path;
    ...
    invoke-interface {v0, p1, p2}, Ll/ᩴ᩵ۙ;->subpath(II)Ll/ᩴ᩵ۙ;
...
.method public final synthetic toAbsolutePath()Ljava/nio/file/Path;
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->toAbsolutePath()Ll/ᩴ᩵ۙ;
...
.method public final synthetic toFile()Ljava/io/File;
    ...
    invoke-interface {v0}, Ll/ᩴ᩵ۙ;->toFile()Ljava/io/File;
...
.method public final synthetic toRealPath([Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;
    ...
    invoke-static {p1}, Ll/ۨ᩸ۙ;->I([Ljava/nio/file/LinkOption;)[Ll/ܺ᩵ۙ;

    move-result-object p1

    invoke-interface {v0, p1}, Ll/ᩴ᩵ۙ;->toRealPath([Ll/ܺ᩵ۙ;)Ll/ᩴ᩵ۙ;
