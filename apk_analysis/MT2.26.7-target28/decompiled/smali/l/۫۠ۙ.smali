.class public final synthetic Ll/۫۠ۙ;
...
.method public synthetic constructor <init>(Ljava/util/stream/DoubleStream;)V
    ...
    iput-object p1, p0, Ll/۫۠ۙ;->a:Ljava/util/stream/DoubleStream;

    return-void
.end method

.method public static synthetic b(Ljava/util/stream/DoubleStream;)Ll/ۙ᩹ۙ;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۡ᩹ۙ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۡ᩹ۙ;

    iget-object p0, p0, Ll/ۡ᩹ۙ;->a:Ll/ۙ᩹ۙ;

    return-object p0

    :cond_1
    new-instance v0, Ll/۫۠ۙ;

    invoke-direct {v0, p0}, Ll/۫۠ۙ;-><init>(Ljava/util/stream/DoubleStream;)V
...
.method public final a(Ll/ܰ᩸ۙ;)Ll/ۙ᩹ۙ;
    ...
    .line 0
    iget-object v0, p0, Ll/۫۠ۙ;->a:Ljava/util/stream/DoubleStream;
...
.method public final synthetic distinct()Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic dropWhile(Ljava/util/function/DoublePredicate;)Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/۫۠ۙ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/۫۠ۙ;

    iget-object p1, p1, Ll/۫۠ۙ;->a:Ljava/util/stream/DoubleStream;
...
.method public final synthetic filter(Ljava/util/function/DoublePredicate;)Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic findAny()Ll/۠ᩴۙ;
    .locals 1
...
.method public final synthetic findFirst()Ll/۠ᩴۙ;
    .locals 1
...
.method public final synthetic h()Ll/ܳۚۙ;
    .locals 2

    const/4 v0, 0x0

    .line 0
    iget-object v1, p0, Ll/۫۠ۙ;->a:Ljava/util/stream/DoubleStream;
...
.method public final synthetic i()Ll/ܶᩳۙ;
    .locals 2
...
.method public final synthetic iterator()Ll/֨֫ۙ;
    .locals 2
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Ll/ܿ֫ۙ;

    if-eqz v1, :cond_1

    check-cast v0, Ll/ܿ֫ۙ;

    iget-object v0, v0, Ll/ܿ֫ۙ;->a:Ll/֨֫ۙ;

    return-object v0

    :cond_1
    new-instance v1, Ll/۫֫ۙ;

    invoke-direct {v1, v0}, Ll/۫֫ۙ;-><init>(Ljava/util/PrimitiveIterator$OfDouble;)V

    return-object v1
.end method

.method public final synthetic limit(J)Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic map(Ljava/util/function/DoubleUnaryOperator;)Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic mapToObj(Ljava/util/function/DoubleFunction;)Ll/ۜ۠ۙ;
    .locals 1
...
.method public final synthetic max()Ll/۠ᩴۙ;
    .locals 1
...
.method public final synthetic min()Ll/۠ᩴۙ;
    .locals 1
...
.method public final synthetic parallel()Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/DoubleConsumer;)Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ll/۠ᩴۙ;
    .locals 1
    ...
    invoke-static {p1}, Ll/۫ܺۙ;->g(Ljava/util/OptionalDouble;)Ll/۠ᩴۙ;
...
.method public final synthetic sequential()Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic skip(J)Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic sorted()Ll/ۙ᩹ۙ;
    .locals 1
...
.method public final synthetic spliterator()Ll/᩶ᩳۙ;
    .locals 1
    ...
    invoke-static {v0}, Ll/ۗᩳۙ;->a(Ljava/util/Spliterator$OfDouble;)Ll/᩶ᩳۙ;
...
.method public final synthetic takeWhile(Ljava/util/function/DoublePredicate;)Ll/ۙ᩹ۙ;
    .locals 1
