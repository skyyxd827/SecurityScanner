...
.method public abstract write(Ll/ۘܳۖ;)V
.end method
...
.method public writeTo(Ljava/io/Writer;Lbin/mt/json/WriterConfig;)V
    ...
    .line 275
    new-instance v0, Ll/֡ۗۖ;

    const/16 v1, 0x80

    invoke-direct {v0, p1, v1}, Ll/֡ۗۖ;-><init>(Ljava/io/Writer;I)V

    .line 276
    invoke-virtual {p2, v0}, Lbin/mt/json/WriterConfig;->createWriter(Ljava/io/Writer;)Ll/ۘܳۖ;

    move-result-object p1

    invoke-virtual {p0, p1}, Lbin/mt/json/JSONValue;->write(Ll/ۘܳۖ;)V

    .line 277
    invoke-virtual {v0}, Ll/֡ۗۖ;->flush()V
