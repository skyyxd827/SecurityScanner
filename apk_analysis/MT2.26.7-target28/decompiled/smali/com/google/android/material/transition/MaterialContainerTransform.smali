...
.method public static captureValues(Ll/ۛۤۡ;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
    .locals 2
    ...
    .line 815
    iget-object p1, p0, Ll/ۛۤۡ;->֡:Landroid/view/View;
    ...
    iput-object p1, p0, Ll/ۛۤۡ;->֡:Landroid/view/View;
    ...
    .line 822
    iget-object p2, p0, Ll/ۛۤۡ;->֡:Landroid/view/View;
...
.method public static getElevationOrDefault(FLandroid/view/View;)F
    ...
    .line 1020
    :cond_0
    invoke-static {p1}, Ll/ۖܶ;->ۧ(Landroid/view/View;)F
...
.method private maybeApplyThemeValues(Landroid/content/Context;Z)V
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/google/android/material/transition/TransitionUtils;->maybeApplyThemeInterpolator(Ll/۫ܿۡ;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    ...
    .line 1012
    :goto_0
    invoke-static {p0, p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->maybeApplyThemeDuration(Ll/۫ܿۡ;Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->maybeApplyThemePath(Ll/۫ܿۡ;Landroid/content/Context;I)Z
...
.method public captureEndValues(Ll/ۛۤۡ;)V
    ...
    invoke-static {p1, v0, v1, v2}, Lcom/google/android/material/transition/MaterialContainerTransform;->captureValues(Ll/ۛۤۡ;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Ll/ۛۤۡ;Ll/ۛۤۡ;)Landroid/animation/Animator;
    ...
    .line 888
    iget-object v3, v0, Ll/ۛۤۡ;->ۡ:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v4, v1, Ll/ۛۤۡ;->ۡ:Ljava/util/HashMap;
    ...
    .line 908
    :cond_2
    iget-object v4, v0, Ll/ۛۤۡ;->֡:Landroid/view/View;

    .line 909
    iget-object v5, v1, Ll/ۛۤۡ;->֡:Landroid/view/View;
    ...
    .line 926
    invoke-virtual {v11, v7, v3}, Landroid/graphics/RectF;->offset(FF)V

    .line 927
    invoke-virtual {v15, v7, v3}, Landroid/graphics/RectF;->offset(FF)V

    .line 929
    invoke-direct {v6, v11, v15}, Lcom/google/android/material/transition/MaterialContainerTransform;->isEntering(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    ...
    .line 937
    :cond_5
    new-instance v7, Lcom/google/android/material/transition/MaterialContainerTransform$TransitionDrawable;
    ...
    .line 947
    invoke-static {v0, v5}, Lcom/google/android/material/transition/MaterialContainerTransform;->getElevationOrDefault(FLandroid/view/View;)F
    ...
    .line 954
    invoke-static {v0, v3}, Lcom/google/android/material/transition/FadeModeEvaluators;->get(IZ)Lcom/google/android/material/transition/FadeModeEvaluator;
    ...
    .line 955
    invoke-static {v0, v3, v11, v15}, Lcom/google/android/material/transition/FitModeEvaluators;->get(IZLandroid/graphics/RectF;Landroid/graphics/RectF;)Lcom/google/android/material/transition/FitModeEvaluator;
    ...
    .line 960
    invoke-virtual {v7, v0, v3, v8, v1}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    invoke-direct {v0, v6, v7}, Lcom/google/android/material/transition/MaterialContainerTransform$1;-><init>(Lcom/google/android/material/transition/MaterialContainerTransform;Lcom/google/android/material/transition/MaterialContainerTransform$TransitionDrawable;)V
    ...
    invoke-virtual {v6, v9}, Ll/۫ܿۡ;->addListener(Ll/ᩴܿۡ;)Ll/۫ܿۡ;
