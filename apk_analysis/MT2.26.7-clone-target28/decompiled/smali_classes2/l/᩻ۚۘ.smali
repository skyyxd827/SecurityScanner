...
.method public constructor <init>(Ljava/util/ArrayList;I)V
    ...
    .line 89
    iput p2, p0, Ll/᩻ۚۘ;->᩵:I

    .line 90
    iput-object p1, p0, Ll/᩻ۚۘ;->֨:Ljava/util/ArrayList;

    return-void
.end method

.method public static ᩵(Ljava/util/ArrayList;)Ll/᩻ۚۘ;
    .locals 6
    ...
    check-cast v4, Ll/᩻ۚۘ;

    .line 162
    iget-object v4, v4, Ll/᩻ۚۘ;->֨:Ljava/util/ArrayList;
    ...
    check-cast v1, Ll/᩻ۚۘ;

    iget-object v1, v1, Ll/᩻ۚۘ;->֨:Ljava/util/ArrayList;
    ...
    check-cast p0, Ll/᩻ۚۘ;

    return-object p0
.end method

.method public static ᩵([B)Ll/᩻ۚۘ;
    .locals 16
    ...
    .line 104
    invoke-static {v0}, Ll/ۡ᩵ۛ;->᩵(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    move-result-object v7

    .line 105
    invoke-static {v7}, Ll/ۡ᩵ۛ;->᩵(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 108
    invoke-static {v6}, Ll/֫ۚۘ;->᩵(I)Ll/֫ۚۘ;

    move-result-object v9

    .line 109
    invoke-static {v7}, Ll/ۡ᩵ۛ;->֨(Ljava/nio/ByteBuffer;)[B

    move-result-object v13
    :try_end_0
    .catch Ll/ܽ᩵ۛ; {:try_start_0 .. :try_end_0} :catch_6
    ...
    .line 115
    invoke-virtual {v9}, Ll/֫ۚۘ;->ۛ()Ljava/lang/String;

    move-result-object v11

    .line 117
    invoke-virtual {v9}, Ll/֫ۚۘ;->۠()Ljava/security/spec/AlgorithmParameterSpec;

    move-result-object v9

    .line 118
    invoke-virtual {v4}, Ll/ۨ᩵ۛ;->getPublicKey()Ljava/security/PublicKey;
    ...
    .line 133
    invoke-static {v8}, Ll/ۡ᩵ۛ;->֨(Ljava/nio/ByteBuffer;)[B
    ...
    :cond_5
    :goto_2
    invoke-static {v0}, Ll/ۜ᩵ۛ;->᩵([B)Ljava/security/cert/X509Certificate;

    move-result-object v4

    .line 140
    new-instance v6, Ll/۬᩵ۛ;

    invoke-direct {v6, v4, v0}, Ll/۬᩵ۛ;-><init>(Ljava/security/cert/X509Certificate;[B)V
    ...
    .line 148
    new-instance v0, Ll/ۜ᩺ۘ;

    .line 149
    invoke-static {v8}, Ll/֫ۚۘ;->᩵(I)Ll/֫ۚۘ;

    move-result-object v11

    .line 150
    invoke-static {v15}, Ll/֫ۚۘ;->᩵(I)Ll/֫ۚۘ;
    ...
    invoke-direct/range {v9 .. v14}, Ll/ۜ᩺ۘ;-><init>(Ll/۬᩵ۛ;Ll/֫ۚۘ;Ll/֫ۚۘ;[BI)V
    ...
    throw v0
    :try_end_1
    .catch Ll/ܽ᩵ۛ; {:try_start_1 .. :try_end_1} :catch_6
    ...
    .line 0
    invoke-static {v1, v4, v2}, Ll/᩻ۤ;->᩵(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    check-cast v2, Ll/ۜ᩺ۘ;

    .line 171
    iget-object v2, v2, Ll/ۜ᩺ۘ;->ۘ:Ll/֫ۚۘ;

    if-eqz v2, :cond_b

    .line 172
    invoke-virtual {v2}, Ll/֫ۚۘ;->ۘ()I
    ...
    invoke-direct {v0, v3, v1}, Ll/᩻ۚۘ;-><init>(Ljava/util/ArrayList;I)V
...
.method public final ᩵()I
    ...
    .line 162
    iget-object v0, p0, Ll/᩻ۚۘ;->֨:Ljava/util/ArrayList;
...
.method public final ᩵(Ljava/security/cert/X509Certificate;)Ll/᩻ۚۘ;
    .locals 4
    ...
    .line 303
    :goto_0
    iget-object v2, p0, Ll/᩻ۚۘ;->֨:Ljava/util/ArrayList;
    ...
    check-cast v3, Ll/ۜ᩺ۘ;

    iget-object v3, v3, Ll/ۜ᩺ۘ;->۠:Ll/۬᩵ۛ;

    invoke-virtual {v3, p1}, Ll/۬᩵ۛ;->equals(Ljava/lang/Object;)Z
    ...
    iget v0, p0, Ll/᩻ۚۘ;->᩵:I

    invoke-direct {p1, v3, v0}, Ll/᩻ۚۘ;-><init>(Ljava/util/ArrayList;I)V
