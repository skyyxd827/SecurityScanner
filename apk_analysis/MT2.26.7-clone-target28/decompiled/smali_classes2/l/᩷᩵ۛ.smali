...
.method public final getStream(ILnet/sf/sevenzipjbinding/ExtractAskMode;)Lnet/sf/sevenzipjbinding/ISequentialOutStream;
    ...
    check-cast p1, Ll/۟᩵ۛ;

    .line 95
    iput-boolean v1, p1, Ll/۟᩵ۛ;->ۨ᩵:Z

    .line 37
    new-instance p1, Ll/ۢᩴ᩵;
    ...
    .line 100
    iput-boolean p2, p1, Ll/۟᩵ۛ;->ۨ᩵:Z
    ...
    check-cast p2, Ll/۟᩵ۛ;

    .line 62
    iget-object v0, p2, Ll/۟᩵ۛ;->ۧ᩵:[Lnet/sf/sevenzipjbinding/ISequentialOutStream;

    iget-object v3, p2, Ll/۟᩵ۛ;->۬᩵:Ll/ۤ᩵ۛ;
    ...
    .line 65
    iget-object v4, p2, Ll/۟᩵ۛ;->ۜ᩵:Lnet/sf/sevenzipjbinding/IInArchive;
    ...
    iput-boolean v4, p2, Ll/۟᩵ۛ;->ۨ᩵:Z

    if-eqz v4, :cond_2

    .line 67
    invoke-interface {v3, p1}, Ll/ۤ᩵ۛ;->ܽ(I)V

    return-object v2

    .line 70
    :cond_2
    invoke-interface {v3, p1}, Ll/ۤ᩵ۛ;->ۡ(I)V
    ...
    .line 75
    :try_start_0
    invoke-interface {v3}, Ll/ۤ᩵ۛ;->ᩳ()Lnet/sf/sevenzipjbinding/ISequentialOutStream;
    ...
    .line 85
    :cond_3
    new-instance p2, Ll/ܰ᩵ۛ;

    invoke-direct {p2, v3, p1}, Ll/ܰ᩵ۛ;-><init>(Ll/ۤ᩵ۛ;Lnet/sf/sevenzipjbinding/ISequentialOutStream;)V
...
.method public final setCompleted(J)V
    ...
    .line 59
    iput-wide p1, p0, Ll/᩷᩵ۛ;->ܺ᩵:J

    .line 60
    iget-wide v0, p0, Ll/᩷᩵ۛ;->ܽ᩵:J

    invoke-virtual {p0, p1, p2, v0, v1}, Ll/᩷᩵ۛ;->ۛ(JJ)V
...
.method public final setTotal(J)V
    ...
    .line 53
    iput-wide p1, p0, Ll/᩷᩵ۛ;->ܽ᩵:J

    .line 54
    iget-wide v0, p0, Ll/᩷᩵ۛ;->ܺ᩵:J

    invoke-virtual {p0, v0, v1, p1, p2}, Ll/᩷᩵ۛ;->ۛ(JJ)V
