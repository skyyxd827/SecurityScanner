...
.method public static ᩵(Ll/ۘᩴ۠;Ljava/lang/String;IZZZ)V
    .locals 2
    ...
    .line 130
    invoke-virtual {v0, p1, p3}, Ll/ۖܰۡ;->᩵(Ljava/lang/String;Z)V

    const-string p1, "relativeNameSubStart"

    .line 131
    invoke-virtual {v0, p2, p1}, Ll/ۖܰۡ;->᩵(ILjava/lang/String;)V

    const-string p1, "extractToAnother"

    .line 132
    invoke-virtual {v0, p1, p4}, Ll/ۖܰۡ;->᩵(Ljava/lang/String;Z)V

    const-string p1, "deleteSources"

    .line 133
    invoke-virtual {v0, p1, p5}, Ll/ۖܰۡ;->᩵(Ljava/lang/String;Z)V

    if-eqz p4, :cond_0

    .line 135
    invoke-virtual {v0, p0}, Ll/ۖܰۡ;->᩵(Ll/ۘᩴ۠;)V
...
.method public static synthetic ᩵(Ll/᩺ۗ۠;ZLandroid/widget/CheckBox;Landroid/widget/CheckBox;Ll/۟ܳ۠;Ll/ۘᩴ۠;Landroid/widget/RadioButton;Ll/ۖۙۡ;Landroid/widget/RadioButton;Landroid/widget/EditText;)V
    .locals 1
    ...
    .line 107
    invoke-virtual {p4}, Ll/۟ܳ۠;->ܶ()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p5}, Ll/ۘᩴ۠;->ۨ()Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p6}, Ll/᩺ۗ۠;->᩵(Ll/ۘᩴ۠;Ljava/lang/String;IZZZ)V

    .line 110
    invoke-virtual {p7}, Ll/ۖۙۡ;->dismiss()V
    ...
    .line 120
    invoke-static {p2, p1}, Ll/᩵ᩳۨ;->᩵(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final ۘ(Ll/ۘᩴ۠;)V
    ...
    invoke-virtual {v6, v0}, Ll/۟ܳ۠;->֨(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v4}, Ll/۠ۖܽ;->᩵(I)Landroid/view/View;
    ...
    .line 95
    new-instance v9, Ll/۠ۖۘ;

    const/4 v12, 0x2

    invoke-direct {v9, v12, v11}, Ll/۠ۖۘ;-><init>(ILjava/lang/Object;)V
    ...
    invoke-interface {v9}, Ll/ۚۧ۠;->ۜ᩵()Ll/۬᩸ۛ;
    ...
    invoke-direct/range {v1 .. v11}, Ll/᩹ۗ۠;-><init>(Ll/᩺ۗ۠;ZLandroid/widget/CheckBox;Landroid/widget/CheckBox;Ll/۟ܳ۠;Ll/ۘᩴ۠;Landroid/widget/RadioButton;Ll/ۖۙۡ;Landroid/widget/RadioButton;Landroid/widget/EditText;)V
