.class public final Ll/ܿۤۡ;
.super Ljava/lang/Object;
.source "B1T2"


# direct methods
.method public static ᩵(Ljava/lang/String;ZZ)Ll/ۜۢۡ;
    .locals 10
    ...
    .line 61
    iget-object v5, p0, Ll/ܽۤۡ;->᩵:Ljava/lang/String;

    if-eqz v5, :cond_4

    .line 63
    :try_start_0
    invoke-static {p0}, Ll/᩹ۤۡ;->᩵(Ll/ܽۤۡ;)V
    :try_end_0
    ...
    .line 108
    invoke-static {v5}, Ll/ۢۨ᩷;->toPath(Ljava/io/File;)Ll/ᩳ۬᩷;

    move-result-object v6

    invoke-static {v6}, Ll/ᩴ۬᩷;->isSymbolicLink(Ll/ᩳ۬᩷;)Z
    ...
    :cond_8
    :goto_4
    invoke-virtual {p0}, Ll/ܽۤۡ;->֨()Ljava/io/File;
    ...
    invoke-static {v5, p0, v3}, Ll/ۧۢۡ;->᩵(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-static {p0, v1, v3}, Ll/ۧۢۡ;->᩵(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V

    .line 162
    new-instance p0, Ll/ۙۤۡ;

    .line 189
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 190
    iput-object v7, p0, Ll/ۙۤۡ;->֨:Ljava/lang/String;
    ...
    iput-object v1, p0, Ll/ۙۤۡ;->᩵:Ljava/util/ArrayList;

    .line 18
    invoke-static {v0}, Ll/۫ᩳۨ;->᩵(Z)Ljava/lang/String;
    ...
    iput-object v0, p0, Ll/ۙۤۡ;->֨:Ljava/lang/String;
    ...
    iget-object v8, p0, Ll/ۙۤۡ;->֨:Ljava/lang/String;
    ...
    iput-object p2, p0, Ll/ۙۤۡ;->֨:Ljava/lang/String;
    ...
    :cond_d
    :goto_8
    iget-object p2, p0, Ll/ۙۤۡ;->֨:Ljava/lang/String;
    ...
    .line 180
    :cond_e
    iget-object p2, p0, Ll/ۙۤۡ;->᩵:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Ll/ۙۤۡ;->֨:Ljava/lang/String;
    ...
    iget-object v0, p0, Ll/ۙۤۡ;->᩵:Ljava/util/ArrayList;
    ...
    .line 86
    iget-object p0, p0, Ll/ۙۤۡ;->᩵:Ljava/util/ArrayList;

    const/16 p2, 0x20

    invoke-static {p0, p2}, Ll/ۤۗܳ;->᩵(Ljava/util/Collection;C)Ljava/lang/String;
    ...
    .line 24
    invoke-static {v4}, Ll/۫ᩳۨ;->᩵(Z)Ljava/lang/String;
    ...
    .line 99
    :cond_13
    new-instance p2, Ll/ۜۢۡ;

    new-instance v6, Ll/᩹ۢۡ;

    invoke-direct {v6}, Ll/᩹ۢۡ;-><init>()V
    ...
    invoke-direct/range {v0 .. v6}, Ll/ۜۢۡ;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ZLl/᩹ۢۡ;)V

    return-object p2
.end method

.method public static ᩵(Ll/ۜۢۡ;)V
    .locals 4
    ...
    .line 139
    invoke-virtual {p0}, Ll/ۜۢۡ;->ۡ()Ljava/lang/String;
    ...
    .line 140
    invoke-virtual {p0, v0}, Ll/᩶᩸ۡ;->֨(Ljava/lang/String;)V
    ...
    new-instance v3, Ll/ۖۤۡ;

    invoke-direct {v3, p0, v0, v1}, Ll/ۖۤۡ;-><init>(Ll/ۜۢۡ;J)V
