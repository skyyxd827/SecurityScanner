...
.field public final d:Ll/ᩳ۬᩷;


# direct methods
.method public constructor <init>(Ljava/nio/channels/FileChannel;ZZLl/ᩳ۬᩷;)V
    .locals 0
    ...
    .line 156
    iput-object p1, p0, Ll/᩷ۨ᩷;->a:Ljava/nio/channels/FileChannel;

    .line 157
    iput-boolean p2, p0, Ll/᩷ۨ᩷;->b:Z

    .line 158
    iput-boolean p3, p0, Ll/᩷ۨ᩷;->c:Z
    ...
    .line 159
    :goto_0
    iput-object p4, p0, Ll/᩷ۨ᩷;->d:Ll/ᩳ۬᩷;
...
.method public final force(Z)V
    ...
    .line 207
    iget-object v0, p0, Ll/᩷ۨ᩷;->a:Ljava/nio/channels/FileChannel;
...
.method public final implCloseChannel()V
    ...
    .line 258
    iget-boolean v0, p0, Ll/᩷ۨ᩷;->b:Z

    if-eqz v0, :cond_0

    .line 259
    iget-object v0, p0, Ll/᩷ۨ᩷;->d:Ll/ᩳ۬᩷;
...
.method public final lock(JJZ)Ljava/nio/channels/FileLock;
    ...
    .line 251
    :cond_0
    new-instance p2, Ll/ܳۨ᩷;

    invoke-direct {p2, p1, p0}, Ll/ܳۨ᩷;-><init>(Ljava/nio/channels/FileLock;Ll/᩷ۨ᩷;)V
...
.method public final position(J)Ljava/nio/channels/FileChannel;
    ...
    .line 140
    :cond_0
    new-instance p2, Ll/᩷ۨ᩷;

    const/4 v0, 0x0

    const/4 v1, 0x0

    invoke-direct {p2, p1, v1, v1, v0}, Ll/᩷ۨ᩷;-><init>(Ljava/nio/channels/FileChannel;ZZLl/ᩳ۬᩷;)V
...
.method public final bridge synthetic position(J)Ljava/nio/channels/SeekableByteChannel;
    ...
    .line 129
    invoke-virtual {p0, p1, p2}, Ll/᩷ۨ᩷;->position(J)Ljava/nio/channels/FileChannel;
...
.method public final bridge synthetic truncate(J)Ljava/nio/channels/SeekableByteChannel;
    ...
    .line 129
    invoke-virtual {p0, p1, p2}, Ll/᩷ۨ᩷;->truncate(J)Ljava/nio/channels/FileChannel;
