...
.method private drawForHorizontalOrientation(Landroid/graphics/Canvas;Ll/ܶܿ֨;)V
    .locals 9
    ...
    .line 350
    invoke-virtual {p2}, Ll/ܶܿ֨;->getClipToPadding()Z
    ...
    .line 367
    invoke-direct {p0, p2, v5}, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->shouldDrawDivider(Ll/ܶܿ֨;Landroid/view/View;)Z
    ...
    .line 368
    invoke-virtual {p2}, Ll/ܶܿ֨;->getLayoutManager()Ll/ۤۙ֨;

    move-result-object v6

    iget-object v7, p0, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->tempRect:Landroid/graphics/Rect;

    invoke-virtual {v6, v5, v7}, Ll/ۤۙ֨;->getDecoratedBoundsWithMargins(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private drawForVerticalOrientation(Landroid/graphics/Canvas;Ll/ܶܿ֨;)V
    .locals 8
    ...
    .line 328
    invoke-direct {p0, p2, v4}, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->shouldDrawDivider(Ll/ܶܿ֨;Landroid/view/View;)Z
    ...
    invoke-virtual {v5, v4, v6}, Ll/ۤۙ֨;->getDecoratedBoundsWithMargins(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private shouldDrawDivider(Ll/ܶܿ֨;Landroid/view/View;)Z
    .locals 4

    .line 411
    invoke-virtual {p1, p2}, Ll/ܶܿ֨;->getChildAdapterPosition(Landroid/view/View;)I
    ...
    .line 417
    :cond_1
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->shouldDrawDivider(ILl/᩷ۙ֨;)Z
...
.method public getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Ll/ܶܿ֨;Ll/ۜܿ֨;)V
    .locals 0
    ...
    .line 397
    invoke-direct {p0, p3, p2}, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->shouldDrawDivider(Ll/ܶܿ֨;Landroid/view/View;)Z
...
.method public onDraw(Landroid/graphics/Canvas;Ll/ܶܿ֨;Ll/ۜܿ֨;)V
    .locals 1
    ...
    .line 298
    invoke-direct {p0, p1, p2}, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->drawForVerticalOrientation(Landroid/graphics/Canvas;Ll/ܶܿ֨;)V

    return-void

    .line 300
    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/google/android/material/divider/MaterialDividerItemDecoration;->drawForHorizontalOrientation(Landroid/graphics/Canvas;Ll/ܶܿ֨;)V
...
.method public setDividerColorResource(Landroid/content/Context;I)V
    ...
    .line 190
    invoke-static {p1, p2}, Ll/ܰܿ;->᩵(Landroid/content/Context;I)I
...
.method public shouldDrawDivider(ILl/᩷ۙ֨;)Z
    .locals 0
