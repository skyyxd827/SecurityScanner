...
.method public static bisectToLimit(DD)[D
    ...
    invoke-static {v6, v7}, Lcom/google/android/material/color/utilities/HctSolver;->criticalPlaneBelow(D)I
    ...
    invoke-static {v6, v7}, Lcom/google/android/material/color/utilities/HctSolver;->criticalPlaneAbove(D)I
    ...
    .line 544
    sget-object v6, Lcom/google/android/material/color/utilities/HctSolver;->CRITICAL_PLANES:[D

    aget-wide v7, v6, v15

    .line 545
    invoke-static {v1, v7, v8, v0, v5}, Lcom/google/android/material/color/utilities/HctSolver;->setCoordinate([DD[DI)[D
    ...
    .line 547
    invoke-static/range {v6 .. v11}, Lcom/google/android/material/color/utilities/HctSolver;->areInCyclicOrder(DDD)Z
    ...
    .line 559
    :cond_4
    invoke-static {v1, v0}, Lcom/google/android/material/color/utilities/HctSolver;->midpoint([D[D)[D
...
.method public static findResultByJ(DDD)I
    ...
    mul-double v5, v2, v15

    mul-double v2, v2, v13

    const-wide v7, 0x407cc00000000000L    # 460.0

    mul-double v0, v0, v7

    const-wide v7, 0x407c300000000000L    # 451.0

    mul-double v7, v7, v5

    add-double/2addr v7, v0

    const-wide/high16 v27, 0x4072000000000000L    # 288.0
    ...
    const-wide v29, 0x408bd80000000000L    # 891.0

    mul-double v29, v29, v5

    sub-double v29, v0, v29

    const-wide v31, 0x4070500000000000L    # 261.0
    ...
    const-wide v31, 0x406b800000000000L    # 220.0
    ...
    .line 605
    invoke-static/range {v27 .. v28}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D

    move-result-wide v2

    .line 606
    invoke-static/range {v29 .. v30}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    .line 609
    invoke-static {v7, v0}, Lcom/google/android/material/color/utilities/MathUtils;->matrixMultiply([D[[D)[D
    ...
    const-wide v19, 0x3f60624dd2f1a9fcL    # 0.002
