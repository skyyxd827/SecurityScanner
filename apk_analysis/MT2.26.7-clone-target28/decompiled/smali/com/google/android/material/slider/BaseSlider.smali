...
# static fields
.field public static final DEFAULT_LABEL_ANIMATION_ENTER_DURATION:I = 0x53

.field public static final DEFAULT_LABEL_ANIMATION_EXIT_DURATION:I = 0x75

.field public static final DEF_STYLE_RES:I

.field public static final EXCEPTION_ILLEGAL_DISCRETE_VALUE:Ljava/lang/String; = "Value(%s) must be equal to valueFrom(%s) plus a multiple of stepSize(%s) when using stepSize(%s)"

.field public static final EXCEPTION_ILLEGAL_MIN_SEPARATION:Ljava/lang/String; = "minSeparation(%s) must be greater or equal to 0"

.field public static final EXCEPTION_ILLEGAL_MIN_SEPARATION_STEP_SIZE:Ljava/lang/String; = "minSeparation(%s) must be greater or equal and a multiple of stepSize(%s) when using stepSize(%s)"

.field public static final EXCEPTION_ILLEGAL_MIN_SEPARATION_STEP_SIZE_UNIT:Ljava/lang/String; = "minSeparation(%s) cannot be set as a dimension when using stepSize(%s)"

.field public static final EXCEPTION_ILLEGAL_STEP_SIZE:Ljava/lang/String; = "The stepSize(%s) must be 0, or a factor of the valueFrom(%s)-valueTo(%s) range"

.field public static final EXCEPTION_ILLEGAL_VALUE:Ljava/lang/String; = "Slider value(%s) must be greater or equal to valueFrom(%s), and lower or equal to valueTo(%s)"

.field public static final EXCEPTION_ILLEGAL_VALUE_FROM:Ljava/lang/String; = "valueFrom(%s) must be smaller than valueTo(%s)"

.field public static final EXCEPTION_ILLEGAL_VALUE_TO:Ljava/lang/String; = "valueTo(%s) must be greater than valueFrom(%s)"

.field public static final HALO_ALPHA:I = 0x3f

.field public static final LABEL_ANIMATION_ENTER_DURATION_ATTR:I

.field public static final LABEL_ANIMATION_ENTER_EASING_ATTR:I

.field public static final LABEL_ANIMATION_EXIT_DURATION_ATTR:I

.field public static final LABEL_ANIMATION_EXIT_EASING_ATTR:I

.field public static final MIN_TOUCH_TARGET_DP:I = 0x30

.field public static final TAG:Ljava/lang/String; = "BaseSlider"

.field public static final THRESHOLD:D = 1.0E-4

.field public static final THUMB_WIDTH_PRESSED_RATIO:F = 0.5f
...
.field public static final WARNING_FLOATING_POINT_ERROR:Ljava/lang/String; = "Floating point value used for %s(%s). Using floats can have rounding errors which may result in incorrect values. Instead, consider using integers with a custom LabelFormatter to display the value correctly."
...
.field public final onScrollChangedListener:Landroid/view/ViewTreeObserver$OnScrollChangedListener;
...
.field public final trackRect:Landroid/graphics/RectF;
...
.method private createLabelAnimator(Z)Landroid/animation/ValueAnimator;
    ...
    .line 2601
    iget-object v2, p0, Lcom/google/android/material/slider/BaseSlider;->labelsOutAnimator:Landroid/animation/ValueAnimator;
    ...
    .line 2600
    :goto_1
    invoke-static {v2, v1}, Lcom/google/android/material/slider/BaseSlider;->getAnimatorCurrentValueOrDefault(Landroid/animation/ValueAnimator;F)F
...
.method private dimenToValue(F)F
    ...
    invoke-static {v0, v1, p1, v0}, Ll/۫۠᩵;->᩵(FFFF)F
...
.method private getClampedValue(IF)F
    ...
    .line 2537
    :goto_1
    invoke-static {p2, p1, v1}, Ll/ܺ᩶ۨ;->᩵(FFF)F
...
.method private getValueOfTouchPositionAbsolute()F
    ...
    invoke-static {v1, v2, v0, v2}, Ll/۫۠᩵;->᩵(FFFF)F
...
.method private processAttributes(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 469
    sget v2, Ll/ۛۨ۬;->ۛۜ᩵:I

    goto :goto_0

    :cond_0
    sget v2, Ll/ۛۨ۬;->ܺۜ᩵:I
    ...
    .line 48
    invoke-static {p1, v2}, Ll/ܰܿ;->֨(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 48
    invoke-static {p1, p3}, Ll/ܰܿ;->֨(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 507
    sget v2, Ll/ۛۨ۬;->ۚ۬᩵:I

    goto :goto_5

    :cond_6
    sget v2, Ll/ۛۨ۬;->ۗ۬᩵:I
...
.method private updateHaloHotspot()V
    ...
    invoke-static {v0, v4, v5, v1, v2}, Ll/ۙ۟;->᩵(Landroid/graphics/drawable/Drawable;IIII)V
...
.method private validateMinSeparation()V
    ...
    .line 642
    invoke-direct {p0, v2, v3}, Lcom/google/android/material/slider/BaseSlider;->isMultipleOfStepSize(D)Z
...
.method public dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Ll/ۛ֨᩵;->dispatchHoverEvent(Landroid/view/MotionEvent;)Z
...
.method public final getAccessibilityFocusedVirtualViewId()I
    ...
    invoke-virtual {v0}, Ll/ۛ֨᩵;->getAccessibilityFocusedVirtualViewId()I
...
.method public onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, p2}, Ll/ۛ֨᩵;->clearKeyboardFocusForVirtualView(I)Z
    ...
    invoke-virtual {p1, p2}, Ll/ۛ֨᩵;->requestKeyboardFocusForVirtualView(I)Z
...
.method public setFocusedThumbIndex(I)V
    ...
    invoke-virtual {v0, p1}, Ll/ۛ֨᩵;->requestKeyboardFocusForVirtualView(I)Z
...
.method public setThumbStrokeColorResource(I)V
    ...
    .line 48
    invoke-static {v0, p1}, Ll/ܰܿ;->֨(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
