...
.method public final ᩵(Ljava/lang/String;Z)V
    ...
    invoke-static {v0, p1}, Ll/ۢ᩶ۡ;->֨(Ll/ۚ᩶ۡ;Ljava/lang/String;)Ll/۬᩸ۛ;

    move-result-object v1

    .line 27
    invoke-virtual {p0, v1}, Ll/ۢ᩶ۡ;->᩵(Ll/۬᩸ۛ;)Z
    ...
    .line 39
    :cond_2
    invoke-virtual {v0}, Ll/ۚ᩶ۡ;->ܶ()Z

    move-result v2

    if-nez v2, :cond_3

    const-string p1, "425 Couldn\'t open data socket\r\n"

    goto/16 :goto_4

    :cond_3
    const-string v2, "150 Data socket ready\r\n"

    .line 43
    invoke-virtual {v0, v2}, Ll/ۚ᩶ۡ;->ۘ(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v4, v5}, Ll/ܽۨۘ;->seek(J)V
    ...
    .line 57
    iput-wide v4, v0, Ll/ۚ᩶ۡ;->۬᩵:J

    .line 58
    iput-wide v4, v0, Ll/ۚ᩶ۡ;->ܺ᩵:J

    goto :goto_0

    .line 60
    :cond_5
    invoke-virtual {p1, v6, v7}, Ll/ܽۨۘ;->setLength(J)V
    :try_end_1
    ...
    :cond_6
    :goto_1
    invoke-virtual {v0, p2}, Ll/ۚ᩶ۡ;->᩵([B)I
    ...
    .line 83
    invoke-virtual {p1, p2, v5, v2}, Ll/ܽۨۘ;->write([BII)V
    ...
    .line 89
    invoke-virtual {p1, p2, v4, v6}, Ll/ܽۨۘ;->write([BII)V
    ...
    .line 97
    invoke-virtual {p1, p2, v4, v5}, Ll/ܽۨۘ;->write([BII)V
    :try_end_2
    ...
    .line 0
    invoke-static {p2, p1, v2}, Ll/֡᩺ۡ;->᩵(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 115
    invoke-virtual {v0, p1}, Ll/ۚ᩶ۡ;->ۘ(Ljava/lang/String;)V
