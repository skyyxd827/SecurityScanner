.class public final synthetic Ll/۫֡᩷;
...
.method public synthetic constructor <init>(Ljava/util/stream/IntStream;)V
    ...
    iput-object p1, p0, Ll/۫֡᩷;->a:Ljava/util/stream/IntStream;

    return-void
.end method

.method public static synthetic convert(Ljava/util/stream/IntStream;)Ll/᩺֡᩷;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۚ֡᩷;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۚ֡᩷;

    iget-object p0, p0, Ll/ۚ֡᩷;->a:Ll/᩺֡᩷;

    return-object p0

    :cond_1
    new-instance v0, Ll/۫֡᩷;

    invoke-direct {v0, p0}, Ll/۫֡᩷;-><init>(Ljava/util/stream/IntStream;)V
...
.method public final synthetic allMatch(Ljava/util/function/IntPredicate;)Z
    ...
    iget-object v0, p0, Ll/۫֡᩷;->a:Ljava/util/stream/IntStream;
...
.method public final synthetic asDoubleStream()Ll/ܳۖ᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ܰ᩹᩷;->b(Ljava/util/stream/DoubleStream;)Ll/ܳۖ᩷;
...
.method public final synthetic asLongStream()Ll/ۧܰ᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ۙܿ᩷;->b(Ljava/util/stream/LongStream;)Ll/ۧܰ᩷;
...
.method public final synthetic average()Ll/ۖ᩻᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ܰᩴ᩷;->g(Ljava/util/OptionalDouble;)Ll/ۖ᩻᩷;
...
.method public final synthetic boxed()Ll/֨᩹᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ۚۖ᩷;->b(Ljava/util/stream/Stream;)Ll/֨᩹᩷;
...
.method public final synthetic distinct()Ll/᩺֡᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/۫֡᩷;->convert(Ljava/util/stream/IntStream;)Ll/᩺֡᩷;
...
.method public final synthetic dropWhile(Ljava/util/function/IntPredicate;)Ll/᩺֡᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/۫֡᩷;->convert(Ljava/util/stream/IntStream;)Ll/᩺֡᩷;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/۫֡᩷;

    if-eqz v1, :cond_0

    check-cast p1, Ll/۫֡᩷;

    iget-object p1, p1, Ll/۫֡᩷;->a:Ljava/util/stream/IntStream;
...
.method public final synthetic filter(Ljava/util/function/IntPredicate;)Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic findAny()Ll/֨᩻᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ܰᩴ᩷;->h(Ljava/util/OptionalInt;)Ll/֨᩻᩷;
...
.method public final synthetic findFirst()Ll/֨᩻᩷;
    .locals 1
...
.method public final synthetic iterator()Ll/ۛ᩻᩷;
    .locals 2
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Ll/᩺᩶᩷;

    if-eqz v1, :cond_1

    check-cast v0, Ll/᩺᩶᩷;

    iget-object v0, v0, Ll/᩺᩶᩷;->a:Ll/ۛ᩻᩷;

    return-object v0

    :cond_1
    new-instance v1, Ll/ۢ᩶᩷;

    invoke-direct {v1, v0}, Ll/ۢ᩶᩷;-><init>(Ljava/util/PrimitiveIterator$OfInt;)V

    return-object v1
.end method

.method public final synthetic limit(J)Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic map(Ljava/util/function/IntUnaryOperator;)Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ll/ܳۖ᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/ܰ᩹᩷;->b(Ljava/util/stream/DoubleStream;)Ll/ܳۖ᩷;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ll/ۧܰ᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/ۙܿ᩷;->b(Ljava/util/stream/LongStream;)Ll/ۧܰ᩷;
...
.method public final synthetic mapToObj(Ljava/util/function/IntFunction;)Ll/֨᩹᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/ۚۖ᩷;->b(Ljava/util/stream/Stream;)Ll/֨᩹᩷;
...
.method public final synthetic max()Ll/֨᩻᩷;
    .locals 1
...
.method public final synthetic min()Ll/֨᩻᩷;
    .locals 1
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Ll/ܿ֡᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/᩵ۙ᩷;->b(Ljava/util/stream/BaseStream;)Ll/ܿ֡᩷;
...
.method public final synthetic parallel()Ll/ܿ֡᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/᩵ۙ᩷;->b(Ljava/util/stream/BaseStream;)Ll/ܿ֡᩷;
...
.method public final synthetic parallel()Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/IntConsumer;)Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ll/֨᩻᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/ܰᩴ᩷;->h(Ljava/util/OptionalInt;)Ll/֨᩻᩷;
...
.method public final synthetic sequential()Ll/ܿ֡᩷;
    .locals 1
...
.method public final synthetic sequential()Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic skip(J)Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic sorted()Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic spliterator()Ll/ᩳ᩻᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/᩹ۢ᩷;->a(Ljava/util/Spliterator;)Ll/ᩳ᩻᩷;
...
.method public final synthetic spliterator()Ll/᩷᩻᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ᩳ֡᩷;->a(Ljava/util/Spliterator$OfInt;)Ll/᩷᩻᩷;
...
.method public final synthetic takeWhile(Ljava/util/function/IntPredicate;)Ll/᩺֡᩷;
    .locals 1
...
.method public final synthetic unordered()Ll/ܿ֡᩷;
    .locals 1
