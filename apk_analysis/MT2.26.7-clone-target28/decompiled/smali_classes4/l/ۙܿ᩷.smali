.class public final synthetic Ll/ۙܿ᩷;
...
.method public synthetic constructor <init>(Ljava/util/stream/LongStream;)V
    ...
    iput-object p1, p0, Ll/ۙܿ᩷;->a:Ljava/util/stream/LongStream;

    return-void
.end method

.method public static synthetic b(Ljava/util/stream/LongStream;)Ll/ۧܰ᩷;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/᩵ܰ᩷;

    if-eqz v0, :cond_1

    check-cast p0, Ll/᩵ܰ᩷;

    iget-object p0, p0, Ll/᩵ܰ᩷;->a:Ll/ۧܰ᩷;

    return-object p0

    :cond_1
    new-instance v0, Ll/ۙܿ᩷;

    invoke-direct {v0, p0}, Ll/ۙܿ᩷;-><init>(Ljava/util/stream/LongStream;)V
...
.method public final a(Ll/ᩴۨ᩷;)Ll/ۧܰ᩷;
    ...
    .line 0
    iget-object v0, p0, Ll/ۙܿ᩷;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic c()Ll/ܳۖ᩷;
    .locals 2

    const/4 v0, 0x0

    .line 0
    iget-object v1, p0, Ll/ۙܿ᩷;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic distinct()Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic dropWhile(Ljava/util/function/LongPredicate;)Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۙܿ᩷;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۙܿ᩷;

    iget-object p1, p1, Ll/ۙܿ᩷;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic filter(Ljava/util/function/LongPredicate;)Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic findAny()Ll/ܰ᩻᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ܰᩴ᩷;->i(Ljava/util/OptionalLong;)Ll/ܰ᩻᩷;
...
.method public final synthetic findFirst()Ll/ܰ᩻᩷;
    .locals 1
...
.method public final synthetic iterator()Ll/ܺ᩻᩷;
    .locals 2
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Ll/ۡ֡᩷;

    if-eqz v1, :cond_1

    check-cast v0, Ll/ۡ֡᩷;

    iget-object v0, v0, Ll/ۡ֡᩷;->a:Ll/ܺ᩻᩷;

    return-object v0

    :cond_1
    new-instance v1, Ll/۠֡᩷;

    invoke-direct {v1, v0}, Ll/۠֡᩷;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V

    return-object v1
.end method

.method public final synthetic k()Ll/᩺֡᩷;
    .locals 2
...
.method public final synthetic limit(J)Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic map(Ljava/util/function/LongUnaryOperator;)Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Ll/֨᩹᩷;
    .locals 1
...
.method public final synthetic max()Ll/ܰ᩻᩷;
    .locals 1
...
.method public final synthetic min()Ll/ܰ᩻᩷;
    .locals 1
...
.method public final synthetic parallel()Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ll/ܰ᩻᩷;
    .locals 1
    ...
    invoke-static {p1}, Ll/ܰᩴ᩷;->i(Ljava/util/OptionalLong;)Ll/ܰ᩻᩷;
...
.method public final synthetic sequential()Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic skip(J)Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic sorted()Ll/ۧܰ᩷;
    .locals 1
...
.method public final synthetic spliterator()Ll/ᩴ᩻᩷;
    .locals 1
    ...
    invoke-static {v0}, Ll/ۖ֡᩷;->a(Ljava/util/Spliterator$OfLong;)Ll/ᩴ᩻᩷;
...
.method public final synthetic takeWhile(Ljava/util/function/LongPredicate;)Ll/ۧܰ᩷;
    .locals 1
