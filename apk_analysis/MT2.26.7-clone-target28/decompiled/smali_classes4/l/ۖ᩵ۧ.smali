...
.field public static ۠:Ljava/math/BigInteger;


# instance fields
.field public ֨:Ljavax/crypto/KeyAgreement;

.field public ۘ:Ljava/security/interfaces/ECPublicKey;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Ll/ۖ᩵ۧ;->۠:Ljava/math/BigInteger;
    ...
    sput-object v0, Ll/ۖ᩵ۧ;->ۛ:Ljava/math/BigInteger;
...
.method public final getQ()[B
    ...
    .line 61
    iget-object v0, p0, Ll/ۖ᩵ۧ;->᩵:[B

    return-object v0
.end method

.method public final ֨([B[B)Z
    .locals 6
    ...
    .line 99
    :cond_0
    iget-object p2, p0, Ll/ۖ᩵ۧ;->ۘ:Ljava/security/interfaces/ECPublicKey;
    ...
    sget-object v4, Ll/ۖ᩵ۧ;->ۛ:Ljava/math/BigInteger;
    ...
    .line 111
    sget-object v0, Ll/ۖ᩵ۧ;->۠:Ljava/math/BigInteger;
...
.method public final ᩵(I)V
    ...
    iput-object v0, p0, Ll/ۖ᩵ۧ;->֨:Ljavax/crypto/KeyAgreement;

    .line 50
    new-instance v0, Ll/ۨ֨ۧ;

    invoke-direct {v0}, Ll/ۨ֨ۧ;-><init>()V
    ...
    iput-object v8, v0, Ll/ۨ֨ۧ;->֨:Ljava/security/interfaces/ECPrivateKey;
    ...
    iput-object v7, v0, Ll/ۨ֨ۧ;->ۘ:Ljava/security/interfaces/ECPublicKey;

    .line 65
    invoke-interface {v7}, Ljava/security/interfaces/ECKey;->getParams()Ljava/security/spec/ECParameterSpec;

    .line 66
    iget-object v7, v0, Ll/ۨ֨ۧ;->֨:Ljava/security/interfaces/ECPrivateKey;
    ...
    iput-object v7, v0, Ll/ۨ֨ۧ;->᩵:[B

    .line 67
    iget-object v7, v0, Ll/ۨ֨ۧ;->ۘ:Ljava/security/interfaces/ECPublicKey;
    ...
    iput-object v7, v0, Ll/ۨ֨ۧ;->۠:[B

    .line 71
    iget-object v8, v0, Ll/ۨ֨ۧ;->ۛ:[B
    ...
    :cond_6
    :goto_3
    iget-object p1, v0, Ll/ۨ֨ۧ;->᩵:[B

    array-length v1, p1

    iget-object v2, v0, Ll/ۨ֨ۧ;->ۛ:[B
    ...
    .line 112
    invoke-static {p1}, Ll/ۗ֨ۧ;->᩵([B)V

    .line 81
    iput-object v1, v0, Ll/ۨ֨ۧ;->᩵:[B

    .line 101
    :cond_7
    iget-object p1, v0, Ll/ۨ֨ۧ;->ۘ:Ljava/security/interfaces/ECPublicKey;

    .line 52
    iput-object p1, p0, Ll/ۖ᩵ۧ;->ۘ:Ljava/security/interfaces/ECPublicKey;

    .line 92
    iget-object p1, v0, Ll/ۨ֨ۧ;->ۛ:[B

    .line 97
    iget-object v1, v0, Ll/ۨ֨ۧ;->۠:[B
    ...
    .line 55
    iput-object v2, p0, Ll/ۖ᩵ۧ;->᩵:[B

    .line 56
    iget-object p1, p0, Ll/ۖ᩵ۧ;->֨:Ljavax/crypto/KeyAgreement;

    .line 105
    iget-object v0, v0, Ll/ۨ֨ۧ;->֨:Ljava/security/interfaces/ECPrivateKey;
...
.method public final ᩵([B[B)[B
    ...
    .line 71
    iget-object p2, p0, Ll/ۖ᩵ۧ;->֨:Ljavax/crypto/KeyAgreement;
