.class public final Ll/ۙۚ֨;
.super Ljava/lang/Object;
.source "4AMG"


# direct methods
.method public static ᩵(Landroid/app/Activity;Landroidx/window/extensions/layout/WindowLayoutInfo;)Ll/ܰ᩺֨;
    .locals 3
    ...
    invoke-static {p0, v1}, Ll/ۙۚ֨;->᩵(Landroid/app/Activity;Landroidx/window/extensions/layout/FoldingFeature;)Ll/᩸ۚ֨;
    ...
    .line 57
    :cond_2
    new-instance p0, Ll/ܰ᩺֨;

    invoke-direct {p0, v0}, Ll/ܰ᩺֨;-><init>(Ljava/util/List;)V

    return-object p0
.end method

.method public static ᩵(Landroid/app/Activity;Landroidx/window/extensions/layout/FoldingFeature;)Ll/᩸ۚ֨;
    .locals 10
    ...
    .line 39
    :cond_2
    sget-object v1, Ll/ܰۚ֨;->ۘ:Ll/ܰۚ֨;

    goto :goto_1

    .line 38
    :cond_3
    sget-object v1, Ll/ܰۚ֨;->֨:Ll/ܰۚ֨;

    .line 42
    :goto_1
    new-instance v4, Ll/۠ۚ֨;
    ...
    invoke-direct {v4, v5}, Ll/۠ۚ֨;-><init>(Landroid/graphics/Rect;)V

    .line 73
    sget-object v5, Ll/᩸᩺֨;->᩵:Ll/᩸᩺֨;
    ...
    .line 54
    invoke-static {p0}, Ll/֫ۚ֨;->᩵(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    .line 111
    :catch_0
    invoke-static {p0}, Ll/᩸᩺֨;->᩵(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    .line 246
    invoke-static {p0}, Ll/ܶۚ֨;->᩵(Landroid/app/Activity;)Z
    ...
    .line 275
    invoke-static {p0, v3}, Ll/ܶۧܳ;->֨(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 64
    :goto_6
    new-instance v3, Ll/۟᩺֨;

    invoke-direct {v3, p0}, Ll/۟᩺֨;-><init>(Landroid/graphics/Rect;)V

    .line 73
    invoke-virtual {v3}, Ll/۟᩺֨;->᩵()Landroid/graphics/Rect;

    move-result-object p0

    .line 65
    invoke-virtual {v4}, Ll/۠ۚ֨;->᩵()I

    move-result v3

    if-nez v3, :cond_e

    invoke-virtual {v4}, Ll/۠ۚ֨;->ۛ()I
    ...
    .line 44
    :cond_11
    new-instance p0, Ll/᩸ۚ֨;

    new-instance v2, Ll/۠ۚ֨;

    invoke-virtual {p1}, Landroidx/window/extensions/layout/FoldingFeature;->getBounds()Landroid/graphics/Rect;

    move-result-object p1

    invoke-static {p1, v6}, Ll/ܶۧܳ;->֨(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {v2, p1}, Ll/۠ۚ֨;-><init>(Landroid/graphics/Rect;)V

    invoke-direct {p0, v2, v0, v1}, Ll/᩸ۚ֨;-><init>(Ll/۠ۚ֨;Ll/ۤۚ֨;Ll/ܰۚ֨;)V
