...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ll/֨᩵ۛ;->ۘ:Ljava/util/HashMap;
    ...
    sput-object v0, Ll/֨᩵ۛ;->ۛ:Ljava/util/HashMap;
...
.method public constructor <init>([B)V
    ...
    const-class v0, Ll/ۢۗۘ;

    invoke-static {p1, v0}, Ll/ᩳ᩺ۘ;->᩵(Ljava/nio/ByteBuffer;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 36
    iget-object p1, p1, Ll/ۢۗۘ;->᩵:Ll/ۢ᩺ۘ;

    invoke-virtual {p1}, Ll/ۢ᩺ۘ;->᩵()Ljava/nio/ByteBuffer;

    move-result-object p1

    const-class v0, Ll/ۛ᩵ۛ;

    invoke-static {p1, v0}, Ll/ᩳ᩺ۘ;->᩵(Ljava/nio/ByteBuffer;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Ll/ۛ᩵ۛ;

    iput-object p1, p0, Ll/֨᩵ۛ;->᩵:Ll/ۛ᩵ۛ;

    .line 37
    iget-object p1, p1, Ll/ۛ᩵ۛ;->᩵:Ljava/util/List;

    invoke-static {p1}, Ll/֨᩵ۛ;->᩵(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ll/֨᩵ۛ;->֨:Ljava/util/List;
...
.method public static ֨(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 325
    sget-object v0, Ll/֨᩵ۛ;->ۛ:Ljava/util/HashMap;
...
.method public static ᩵(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 242
    sget-object v0, Ll/֨᩵ۛ;->ۘ:Ljava/util/HashMap;
...
.method public static ᩵(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v2, Ll/ۢ᩺ۘ;

    .line 180
    invoke-virtual {v2}, Ll/ۢ᩺ۘ;->᩵()Ljava/nio/ByteBuffer;
    ...
    .line 182
    :try_start_0
    invoke-static {v3}, Ll/ۜ᩵ۛ;->᩵([B)Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {v4, v2, v3}, Ll/۬᩵ۛ;-><init>(Ljava/security/cert/X509Certificate;[B)V
...
.method public final ᩵([B)Z
    ...
    .line 47
    iget-object v2, v1, Ll/֨᩵ۛ;->᩵:Ll/ۛ᩵ۛ;

    iget-object v3, v2, Ll/ۛ᩵ۛ;->۠:Ljava/util/List;
    ...
    .line 50
    :cond_0
    iget-object v3, v2, Ll/ۛ᩵ۛ;->᩵:Ljava/util/List;

    invoke-static {v3}, Ll/֨᩵ۛ;->᩵(Ljava/util/List;)Ljava/util/List;

    move-result-object v3

    .line 52
    iget-object v4, v2, Ll/ۛ᩵ۛ;->۠:Ljava/util/List;
    ...
    check-cast v6, Ll/ܺ᩵ۛ;

    .line 65
    iget-object v8, v6, Ll/ܺ᩵ۛ;->᩵:Ll/ۤۗۘ;

    iget-object v8, v8, Ll/ۤۗۘ;->᩵:Ljava/lang/String;

    .line 66
    iget-object v9, v6, Ll/ܺ᩵ۛ;->ۛ:Ll/ۤۗۘ;

    iget-object v9, v9, Ll/ۤۗۘ;->᩵:Ljava/lang/String;

    .line 72
    iget-object v10, v6, Ll/ܺ᩵ۛ;->֨:Ll/۠᩵ۛ;
    ...
    .line 208
    iget-object v13, v10, Ll/۠᩵ۛ;->᩵:Ll/ۚۗۘ;
    ...
    .line 213
    :cond_3
    iget-object v15, v13, Ll/ۚۗۘ;->֨:Ll/ۢ᩺ۘ;

    .line 214
    invoke-virtual {v15}, Ll/ۢ᩺ۘ;->᩵()Ljava/nio/ByteBuffer;
    ...
    .line 216
    iget-object v13, v13, Ll/ۚۗۘ;->᩵:Ljava/math/BigInteger;
    ...
    :cond_8
    :goto_5
    sget-object v10, Ll/֨᩵ۛ;->ۛ:Ljava/util/HashMap;
    ...
    .line 352
    :goto_6
    invoke-static {v8}, Ll/֨᩵ۛ;->᩵(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 0
    invoke-static {v13, v10, v11}, Ll/֡ۘۘ;->᩵(ILjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v10, v11, v9}, Ll/۟ۗۧ;->᩵(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 105
    iget-object v10, v6, Ll/ܺ᩵ۛ;->۠:Ll/ۢ᩺ۘ;

    if-eqz v10, :cond_11

    .line 109
    :try_start_0
    invoke-virtual {v10}, Ll/ۢ᩺ۘ;->᩵()Ljava/nio/ByteBuffer;

    move-result-object v10

    .line 108
    invoke-static {v10}, Ll/ᩳ᩺ۘ;->ܽ(Ljava/nio/ByteBuffer;)Ljava/util/ArrayList;

    move-result-object v10

    .line 110
    new-instance v11, Ll/᩵᩵ۛ;

    invoke-direct {v11, v10}, Ll/᩵᩵ۛ;-><init>(Ljava/util/ArrayList;)V

    .line 113
    invoke-virtual {v11}, Ll/᩵᩵ۛ;->᩵()Ljava/lang/String;
    ...
    .line 118
    iget-object v13, v2, Ll/ۛ᩵ۛ;->ۛ:Ll/۫ۗۘ;

    iget-object v13, v13, Ll/۫ۗۘ;->֨:Ljava/lang/String;
    ...
    .line 150
    :cond_e
    iget-object v8, v6, Ll/ܺ᩵ۛ;->۠:Ll/ۢ᩺ۘ;

    invoke-virtual {v8}, Ll/ۢ᩺ۘ;->᩵()Ljava/nio/ByteBuffer;
    ...
    throw v0
    :try_end_1
    .catch Ll/֡᩺ۘ; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 159
    :goto_8
    iget-object v6, v6, Ll/ܺ᩵ۛ;->ۘ:Ljava/nio/ByteBuffer;
    ...
    .line 0
    invoke-static {v2, v8, v3, v9}, Ll/ۚۚ᩷;->᩵(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 58
    iget-object v2, v2, Ll/ۛ᩵ۛ;->۠:Ljava/util/List;
...
.method public final ᩵()[Ljava/security/cert/X509Certificate;
    .locals 2

    .line 41
    iget-object v0, p0, Ll/֨᩵ۛ;->֨:Ljava/util/List;
