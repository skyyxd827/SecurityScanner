...
# virtual methods
.method public final ᩵(Ll/ۢ᩹ܳ;)Ljava/lang/Object;
    .locals 3

    .line 20
    invoke-static {p1}, Ll/᩸ۧۧ;->֨(Ll/ۢ᩹ܳ;)V
    ...
    invoke-static {v0, p1}, Ll/ۚۧۧ;->᩵(Ljava/lang/Class;Ljava/io/InputStream;)Ljava/lang/Object;
    ...
    .line 30
    :try_start_0
    new-instance v2, Ll/ۧۧۧ;

    invoke-direct {v2, v1}, Ll/ۧۧۧ;-><init>(Lcom/thegrizzlylabs/sardineandroid/model/Response;)V
    ...
    .line 24
    :cond_1
    new-instance v0, Ll/ۖۧۧ;

    invoke-virtual {p1}, Ll/ۢ᩹ܳ;->۠()I

    move-result v1

    invoke-virtual {p1}, Ll/ۢ᩹ܳ;->ܶ()Ljava/lang/String;

    move-result-object p1

    const-string v2, "No entity found in response"

    invoke-direct {v0, v2, v1, p1}, Ll/ۖۧۧ;-><init>(Ljava/lang/String;ILjava/lang/String;)V
