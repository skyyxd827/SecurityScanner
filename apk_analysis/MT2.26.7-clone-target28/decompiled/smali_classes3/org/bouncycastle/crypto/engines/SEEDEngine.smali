...
.method private createWorkingKey([B)[I
    ...
    invoke-direct {p0, p1, v2}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->bytesToLong([BI)J

    move-result-wide v3

    const/16 v5, 0x8

    invoke-direct {p0, p1, v5}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->bytesToLong([BI)J

    move-result-wide v5

    invoke-direct {p0, v3, v4}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result p1

    invoke-direct {p0, v3, v4}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW1(J)I

    move-result v7

    invoke-direct {p0, v5, v6}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v8

    invoke-direct {p0, v5, v6}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW1(J)I
    ...
    invoke-direct {p0, v3, v4}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->rotateRight8(J)J
    ...
    :cond_0
    invoke-direct {p0, v5, v6}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->rotateLeft8(J)J
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->getAlgorithmName()Ljava/lang/String;
