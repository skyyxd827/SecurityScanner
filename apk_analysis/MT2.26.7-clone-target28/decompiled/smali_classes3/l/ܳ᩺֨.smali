...
# instance fields
.field public ֨:Ll/᩶ۚ֨;

.field public final ۘ:Landroidx/window/sidecar/SidecarInterface;

.field public final ۛ:Ll/ܽ᩺֨;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 63
    invoke-static {p1}, Ll/ۡ᩺֨;->᩵(Landroid/content/Context;)Landroidx/window/sidecar/SidecarInterface;

    move-result-object p1

    .line 64
    new-instance v0, Ll/ܽ᩺֨;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Ll/ܽ᩺֨;-><init>(I)V

    .line 49
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 50
    iput-object p1, p0, Ll/ܳ᩺֨;->ۘ:Landroidx/window/sidecar/SidecarInterface;

    .line 52
    iput-object v0, p0, Ll/ܳ᩺֨;->ۛ:Ll/ܽ᩺֨;
    ...
    iput-object p1, p0, Ll/ܳ᩺֨;->۠:Ljava/util/LinkedHashMap;
    ...
    iput-object p1, p0, Ll/ܳ᩺֨;->᩵:Ljava/util/LinkedHashMap;

    return-void
.end method

.method public static final synthetic ֨(Ll/ܳ᩺֨;)Ll/ܽ᩺֨;
    .locals 0

    .line 49
    iget-object p0, p0, Ll/ܳ᩺֨;->ۛ:Ll/ܽ᩺֨;

    return-object p0
.end method

.method public static final synthetic ۘ(Ll/ܳ᩺֨;)Ljava/util/LinkedHashMap;
    .locals 0

    .line 49
    iget-object p0, p0, Ll/ܳ᩺֨;->۠:Ljava/util/LinkedHashMap;

    return-object p0
.end method

.method public static final synthetic ᩵(Ll/ܳ᩺֨;)Ll/᩶ۚ֨;
    .locals 0

    .line 49
    iget-object p0, p0, Ll/ܳ᩺֨;->֨:Ll/᩶ۚ֨;
...
# virtual methods
.method public final ֨(Landroid/app/Activity;)V
    .locals 3
    ...
    .line 140
    :cond_2
    iget-object v1, p0, Ll/ܳ᩺֨;->ۘ:Landroidx/window/sidecar/SidecarInterface;
    ...
    .line 150
    :goto_2
    iget-object v1, p0, Ll/ܳ᩺֨;->᩵:Ljava/util/LinkedHashMap;
    ...
    .line 142
    iget-object p1, p0, Ll/ܳ᩺֨;->۠:Ljava/util/LinkedHashMap;
    ...
    .line 145
    iget-object p1, p0, Ll/ܳ᩺֨;->ۘ:Landroidx/window/sidecar/SidecarInterface;
...
.method public final ֨()Z
    ...
    invoke-static {v1, v4}, Ll/ܶۧܳ;->᩵(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v6}, Ll/ܶۧܳ;->᩵(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 207
    invoke-static {v1, v3}, Ll/ܶۧܳ;->ۛ(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method public final ۘ(Landroid/app/Activity;)Ll/ܰ᩺֨;
    .locals 2
    ...
    .line 79
    new-instance p1, Ll/ܰ᩺֨;

    sget-object v0, Ll/ۙۨܳ;->᩺:Ll/ۙۨܳ;

    invoke-direct {p1, v0}, Ll/ܰ᩺֨;-><init>(Ljava/util/List;)V
    ...
    .line 81
    :cond_5
    iget-object v1, p0, Ll/ܳ᩺֨;->ۛ:Ll/ܽ᩺֨;

    invoke-virtual {v1, p1, v0}, Ll/ܽ᩺֨;->᩵(Landroidx/window/sidecar/SidecarWindowLayoutInfo;Landroidx/window/sidecar/SidecarDeviceState;)Ll/ܰ᩺֨;
...
.method public final ᩵()Landroidx/window/sidecar/SidecarInterface;
    .locals 1

    .line 51
    iget-object v0, p0, Ll/ܳ᩺֨;->ۘ:Landroidx/window/sidecar/SidecarInterface;

    return-object v0
.end method

.method public final ᩵(Landroid/app/Activity;)V
    .locals 1
    ...
    .line 90
    invoke-virtual {p0, v0, p1}, Ll/ܳ᩺֨;->᩵(Landroid/os/IBinder;Landroid/app/Activity;)V

    return-void

    .line 92
    :cond_2
    new-instance v0, Ll/ۜ᩺֨;

    invoke-direct {v0, p0, p1}, Ll/ۜ᩺֨;-><init>(Ll/ܳ᩺֨;Landroid/app/Activity;)V
...
.method public final ᩵(Landroid/os/IBinder;Landroid/app/Activity;)V
    .locals 2

    .line 104
    iget-object v0, p0, Ll/ܳ᩺֨;->۠:Ljava/util/LinkedHashMap;
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Ll/ܳ᩺֨;->֨:Ll/᩶ۚ֨;
    ...
    :cond_3
    invoke-virtual {p0, p2}, Ll/ܳ᩺֨;->ۘ(Landroid/app/Activity;)Ll/ܰ᩺֨;

    move-result-object v0

    check-cast p1, Ll/ۨ᩺֨;

    invoke-virtual {p1, p2, v0}, Ll/ۨ᩺֨;->᩵(Landroid/app/Activity;Ll/ܰ᩺֨;)V

    .line 118
    :goto_2
    iget-object p1, p0, Ll/ܳ᩺֨;->᩵:Ljava/util/LinkedHashMap;
    ...
    .line 121
    new-instance v0, Ll/᩷᩺֨;

    invoke-direct {v0, p0, p2}, Ll/᩷᩺֨;-><init>(Ll/ܳ᩺֨;Landroid/app/Activity;)V
...
.method public final ᩵(Ll/ᩴ᩺֨;)V
    .locals 3

    .line 68
    new-instance v0, Ll/ۨ᩺֨;

    invoke-direct {v0, p1}, Ll/ۨ᩺֨;-><init>(Ll/ᩴ᩺֨;)V

    iput-object v0, p0, Ll/ܳ᩺֨;->֨:Ll/᩶ۚ֨;
    ...
    .line 70
    :cond_0
    new-instance v0, Ll/۬᩺֨;

    .line 72
    new-instance v1, Ll/ۧ᩺֨;

    invoke-direct {v1, p0}, Ll/ۧ᩺֨;-><init>(Ll/ܳ᩺֨;)V

    check-cast v1, Landroidx/window/sidecar/SidecarInterface$SidecarCallback;

    .line 70
    iget-object v2, p0, Ll/ܳ᩺֨;->ۛ:Ll/ܽ᩺֨;

    invoke-direct {v0, v2, v1}, Ll/۬᩺֨;-><init>(Ll/ܽ᩺֨;Landroidx/window/sidecar/SidecarInterface$SidecarCallback;)V
